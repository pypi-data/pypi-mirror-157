...
from chiton.fastani.exceptions import FastANIFileNotFound
from tests.fastani import GENOMES, KNOWN_ANI, EXE
...
class TestFastANI(TestCase):
    ...
    def test_fastani_missing_path(self):
        ...
        for exe in EXE:
            self.assertRaises(FastANIFileNotFound, fastani, exe=exe, query=query, reference=reference,
