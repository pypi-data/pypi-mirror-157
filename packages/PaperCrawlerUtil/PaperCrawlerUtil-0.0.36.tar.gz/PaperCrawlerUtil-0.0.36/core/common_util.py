...
def basic_config(log_file_name="../my.log", log_level=logging.WARNING,
    ...
    :param redis_port:
    :param redis_host:
    :param require_crawler_proxy: 是否需要开启爬虫爬取代理ip
    ...
    # if require_crawler_proxy and len(redis_host) > 0 and 65535 >= redis_port >= 0 and 65535 >= redis_database >= 0:
    #     try:
    #         Scheduler().run()
    #     except Exception as e:
    #         log("代理爬虫异常，请检查redis配置：{}".format(e))
