...
class PagesListExtension(Extension):
    ...
    def _render(self, args, caller=None):
        ...
        t = current_app.jinja_env.get_template('_ext-pages-list.html')
        s = t.render(
            pages=pages, 
            cols=cols
        )
...
class PromoPagesExtension(Extension):
    ...
    def _render(self, caller):
        ...
        pages = [
            {'path': '/blog/best-bitcoin-casinos/', 'icon': 'vpns', 'title': 'Best Bitcoin <br/>Casinos'},
            {'path': '/blog/best-ethereum-casinos/', 'icon': 'vpns', 'title': 'Best Ethereum <br/>Casinos'},
            {'path': '/blog/best-casino-games/', 'icon': 'vpns', 'title': 'Best Casino <br/>Games'},
            {'path': '/blog/casino-of-the-month/', 'icon': 'vpns', 'title': 'Casino <br/>of the Month'},
            {'path': '/blog/best-vpns/', 'icon': 'vpns', 'title': 'Best <br/>VPN\'s'},
            {'path': '/blog/the-uk-casinos/', 'icon': 'vpns', 'title': 'Best Casino <br/>in the UK'},
        ]
        s = t.render(pages=pages)
        return s
