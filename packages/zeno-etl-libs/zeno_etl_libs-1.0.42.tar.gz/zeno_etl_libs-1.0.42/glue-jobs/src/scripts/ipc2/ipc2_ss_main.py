...
from zeno_etl_libs.utils.ipc2.portfolio_consolidation import wh_store_portfolio
    ...
    try:
        for store_id in reset_stores:
            ...
            if wh_gen_consolidation == 'Y':
                ...
                safety_stock_df = wh_store_portfolio(
...
if __name__ == '__main__':
    ...
    parser.add_argument('-npi', '--omit_npi', default='Y', type=str,
                        required=False)
    parser.add_argument('-kagc', '--keep_all_generic_comp', default='N',
                        type=str, required=False)
