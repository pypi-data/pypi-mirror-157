...
def average_diameter(dot_array, factor):
    ...
    return fit.average_diameter(dot_array, value)
...
def average_rectangle_size(rect_array, factor):
    ...
    return fit.average_rectangle_size(rect_array, value)
...
def total_surface_area(object_array, factor):
    ...
    return fit.total_surface_area(object_array, value)
...
def field_area(object_array, factor, precision=None):
    ...
    return fit.field_area(object_array, value, precision=precision)
...
def coverage(object_array, factor,
    ...
    return fit.coverage(object_array, value,
                        precision=precision,
...
def average_perimeter(object_array, factor):
    ...
    return fit.average_perimeter(object_array, value)
...
def total_perimeter(object_array, factor):
    ...
    return fit.total_perimeter(object_array, value)
...
def average_surface_area(object_array, factor):
    ...
    return fit.average_surface_area(object_array, value)
...
def log_spacing(object_array, factor, precision=None):
    ...
    return fit.log_spacing(object_array, value, precision=precision)
...
def log_size(object_array, factor):
    ...
    return fit.log_size(object_array, value)
...
def sparcity(object_array, factor, precision=None):
    ...
    return fit.sparcity(object_array, value, precision=precision)
...
def visual_property(object_array, feature, factor):
    ...
    return fit.visual_property(object_array, property_flag=feature, value=value)
