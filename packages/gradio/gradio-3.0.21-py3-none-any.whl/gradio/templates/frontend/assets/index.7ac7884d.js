import { S as SvelteComponent, i as init, s as safe_not_equal, a as svg_element, b as attr, c as insert, d as append, n as noop, e as detach, f as element, H as src_url_equal, A as createEventDispatcher, a6 as onMount, D as binding_callbacks, a7 as add_render_callback, ac as create_bidirectional_transition, W as set_style, l as listen, r as run_all, m as space, ab as add_resize_listener, v as transition_in, y as group_outros, w as transition_out, z as check_outros, o as destroy_each, E as onDestroy, q as create_component, u as mount_component, x as destroy_component, t as toggle_class, a3 as tick, k as empty, J as bind, G as add_flush_callback, h as text, j as set_data, K as component_subscribe, X, L as assign, M as StatusTracker, N as get_spread_update, O as get_spread_object, F as bubble } from './index.2fcf676d.js';
import { B as BlockLabel } from './BlockLabel.0ed1fdd6.js';
import { I as Image } from './Image.29f170e5.js';
import { C as Cropper, i as index, W as Webcam } from './Webcam.a2ccacd1.js';
import { f as fade } from './index.7282bd57.js';
import { I as IconButton, C as Clear, M as ModifyUpload } from './ModifyUpload.8d9465e7.js';
import { U as Upload } from './Upload.8b2e2062.js';
import { B as Block } from './Block.926c8511.js';
export { E as ExampleComponent } from './Image.6ccd524d.js';
...
function create_if_block_6(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*img_width*/ ctx[13] > 0 && create_if_block_7(ctx);
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(img, "load", /*handle_image_load*/ ctx[17]);
				mounted = true;
			}
		},
		p(ctx, dirty) {
			...
			if (/*img_width*/ ctx[13] > 0) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty & /*img_width*/ 8192) {
						transition_in(if_block, 1);
					}
				} else {
...
function create_if_block_4(ctx) {
	...
	cropper.$on("crop", /*handle_save*/ ctx[16]);
	modifyupload = new ModifyUpload({});
	modifyupload.$on("clear", /*clear_handler_1*/ ctx[24]);
...
function create_if_block$2(ctx) {
	...
	modifysketch.$on("undo", /*undo_handler*/ ctx[20]);
	modifysketch.$on("clear", /*clear_handler*/ ctx[21]);
	let sketch_1_props = { value: /*value*/ ctx[0] };
	sketch_1 = new Sketch({ props: sketch_1_props });
	/*sketch_1_binding*/ ctx[22](sketch_1);
	sketch_1.$on("change", /*handle_save*/ ctx[16]);
	...
	return {
		...
		d(detaching) {
			...
			if (detaching) detach(t);
			/*sketch_1_binding*/ ctx[22](null);
			destroy_component(sketch_1, detaching);
		}
	};
}

// (123:2) {#if img_width > 0}
function create_if_block_7(ctx) {
	...
	let sketch_1_props = {
		...
		mode: "mask",
		width: /*img_width*/ ctx[13],
		height: /*img_height*/ ctx[12]
	};

	sketch_1 = new Sketch({ props: sketch_1_props });
	/*sketch_1_binding_1*/ ctx[26](sketch_1);
	sketch_1.$on("change", /*handle_mask_save*/ ctx[18]);
	modifysketch = new ModifySketch({});
	modifysketch.$on("undo", /*undo_handler_1*/ ctx[27]);
	modifysketch.$on("clear", /*handle_mask_clear*/ ctx[19]);
	...
	return {
		...
		p(ctx, dirty) {
			const sketch_1_changes = {};
			if (dirty & /*value*/ 1) sketch_1_changes.value = /*value*/ ctx[0];
			if (dirty & /*img_width*/ 8192) sketch_1_changes.width = /*img_width*/ ctx[13];
			if (dirty & /*img_height*/ 4096) sketch_1_changes.height = /*img_height*/ ctx[12];
			sketch_1.$set(sketch_1_changes);
		},
		i(local) {
			if (current) return;
		...
		d(detaching) {
			/*sketch_1_binding_1*/ ctx[26](null);
			destroy_component(sketch_1, detaching);
			if (detaching) detach(t);
			destroy_component(modifysketch, detaching);
		}
...
function create_if_block_3(ctx) {
	...
	webcam.$on("capture", /*handle_save*/ ctx[16]);
	webcam.$on("stream", /*handle_save*/ ctx[16]);
...
function create_if_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*$$scope, upload_text, or_text, drop_text*/ 536871136) {
...
// (85:3) <Upload     bind:dragging     filetype="image/x-png,image/gif,image/jpeg"     on:load={handle_upload}     include_file_metadata={false}    >
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function handle_image_load(event) {
		...
		$$invalidate(13, img_width = element.naturalWidth);
		$$invalidate(12, img_height = element.naturalHeight);
	}
