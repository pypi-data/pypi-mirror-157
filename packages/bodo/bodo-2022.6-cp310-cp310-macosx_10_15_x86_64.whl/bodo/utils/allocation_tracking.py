...
def get_allocation_stats():
    baaac__kqv = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    ntcwf__yrrby, qwz__rmo, juka__psb, tgvr__bqhx = 0, 0, 0, 0
    for lzqe__obbd in baaac__kqv:
        ntcwf__yrrby += lzqe__obbd[0]
        qwz__rmo += lzqe__obbd[1]
        juka__psb += lzqe__obbd[2]
        tgvr__bqhx += lzqe__obbd[3]
    return ntcwf__yrrby, qwz__rmo, juka__psb, tgvr__bqhx
