...
async function activate(app, mainMenu, docManager) {
    ...
    console.log('Detected your environment as: ', _config__WEBPACK_IMPORTED_MODULE_7__.Globals.AUTHOR_ENV);
        ...
        const showTokenDialog = (notebookTracker, docManager) => {
            ...
            (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showDialog)({
                ...
                if (result.button.accept) {
                    ...
                    //console.log('heres the entered token ', token);
                    ...
                    console.log('Created a new file!', nbPanel);
...
const getLabFilePath = (jwtparsed) => {
    var _a;
    let labFilename = (_a = jwtparsed.filepath) !== null && _a !== void 0 ? _a : _config__WEBPACK_IMPORTED_MODULE_3__.Globals.DEFAULT_LAB_NAME;
...
//# sourceMappingURL=lib_index_js.f706aab8c53e2288d4f0.js.map