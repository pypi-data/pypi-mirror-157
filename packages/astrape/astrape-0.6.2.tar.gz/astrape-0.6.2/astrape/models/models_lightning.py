...
from astrape.base.model_base import BaseNet, ConvNet, GenerativeNet
...
class Generator(GenerativeNet):
    ...
    def criterion(self, img_batch):
        r"""Criterion for loss function for Generative Adversarial Networks.
        ...
        **hparams : Any
        ...
        r"""Discriminator
            ...
            Args:
                ...
                hidden_units (tuple): Tuple of ints describing each layer of the Discriminator

                lr (float): Learning rate. 
                    Default: ``1e-4``

                activation_type (str): Type of the activation layer ("relu", "leaky_relu", or "tanh")
                    Default: ``"leaky_relu"``

                negative_slope (float): The slope of the leaky relu.
                    Default: ``0.2``
        """
