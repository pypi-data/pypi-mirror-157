        ...
        * self.table_of_results_evp = recalculated results for EVP models
        ...
        # (B) EVP models
            ...
            if self.fname == 'evp_s_d_1kv':
                ...
                # Trick: it must be tau1=rtimes[0], but NOT just tau1=rtimes
                # (reason: rtimes -> LIST of floats, and we need FLOAT
                # (note: for evp2 and evp3 it works like: tau1,tau2 = rtimes
