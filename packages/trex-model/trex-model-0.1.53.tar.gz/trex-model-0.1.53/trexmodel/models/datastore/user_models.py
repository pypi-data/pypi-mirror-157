...
class UserBase(UserMin):
    ...
    def create(cls, name=None, email=None, mobile_phone=None, 
        ...
        if create_email_vc:
            ...
            created_user.email_vc_expiry_datetime               = datetime.now() + timedelta(minutes=30)
        
        if create_mobile_phone_vc:
            created_user.mobile_phone_vc                        = random_number(6)
            created_user.mobile_phone_vc_expiry_datetime        = datetime.now() + timedelta(minutes=30)   
    ...
    def mark_mobile_phone_verified(self):
        ...
        self.mobile_phone_verified_datetime = datetime.now()
        self.put()    
    
    def reset_email_vc(self):
        self.email_vc = random_number(6)
        self.email_vc_expiry_datetime = datetime.now() + timedelta(minutes=10)
        self.put() 
        
    def reset_mobile_phone_vc(self):
        self.email_vc = random_number(6)
        self.mobile_phone_vc_expiry_datetime = datetime.now() + timedelta(minutes=10)  
        self.put()   
