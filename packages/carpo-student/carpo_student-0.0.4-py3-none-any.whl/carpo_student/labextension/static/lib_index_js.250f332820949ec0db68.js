...
const plugin = {
    ...
    activate: (app, nbTrack, settingRegistry) => {
        ...
        setInterval(function () {
            ...
            (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('feedback', {
                method: 'GET'
            })
                .then(data => {
                // console.log(data);
        ...
        nbTrack.currentChanged.connect(() => {
            ...
            notebookPanel.context.ready.then(async () => {
                ...
                nbTrack.activeCellChanged.connect(() => {
                    ...
                    const newCheckButton = new _widget__WEBPACK_IMPORTED_MODULE_5__.CellCheckButton(cell, info);
...
class RegisterButton {
    ...
    createNew(panel, context) {
        const register = () => {
            ...
            (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('register', {
                method: 'GET'
            })
                .then(data => {
                console.log(data);
...
class GetQuestionButton {
    ...
    createNew(panel, context) {
        const getQuestion = () => {
            // NotebookActions.clearAllOutputs(panel.content);
            // const notebook = panel.content;
            (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('question', {
                method: 'GET'
            })
                .then(data => {
                console.log(data);
...
class ViewSubmissionStatusButton {
    ...
    createNew(panel, context) {
        const viewStatus = () => {
            (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('view_student_status', {
                method: 'GET'
            })
                .then(data => {
                console.log(data);
...
class viewProblemStatusExtension {
    ...
    createNew(panel, context) {
        const viewProblemStatus = () => {
            (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('view_problem_list', {
                method: 'GET'
            })
                .then(data => {
                console.log(data);
...
//# sourceMappingURL=lib_index_js.250f332820949ec0db68.js.map