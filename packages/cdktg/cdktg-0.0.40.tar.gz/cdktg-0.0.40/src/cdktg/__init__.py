...
class Communication(
    ...
    @jsii.member(jsii_name="isCommunicationl") # type: ignore[misc]
    @builtins.classmethod
    def is_communicationl(cls, x: typing.Any) -> builtins.bool:
        '''
        :param x: -
        '''
        return typing.cast(builtins.bool, jsii.sinvoke(cls, "isCommunicationl", [x]))

    @jsii.member(jsii_name="hasDataAssets")
    def has_data_assets(self) -> builtins.bool:
        return typing.cast(builtins.bool, jsii.invoke(self, "hasDataAssets", []))

    @jsii.member(jsii_name="isBidirectional")
    def is_bidirectional(self) -> builtins.bool:
        return typing.cast(builtins.bool, jsii.invoke(self, "isBidirectional", []))
...
class RiskAspect(metaclass=jsii.JSIIMeta, jsii_type="cdktg.RiskAspect"):
...
class TechnicalAsset(
    ...
    def is_in_scope(self) -> builtins.bool:
        return typing.cast(builtins.bool, jsii.invoke(self, "isInScope", []))
