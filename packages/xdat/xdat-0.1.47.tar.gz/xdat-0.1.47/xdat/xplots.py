...
def plot_multi(df, plot_func='scatter', plot_on=None, group_on=None, color_on=None, label_on=None, figsize=(10,6), alpha=1.0, color_dict=None, title='', x_axis_type=None, legend_loc='best', xlim=None, ylim=None, **kwargs):
