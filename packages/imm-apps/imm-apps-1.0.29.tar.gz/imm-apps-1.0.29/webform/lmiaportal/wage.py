...
from webform.webpage import WebPages
    ...
    def wagePage1(self):
        page_actions = [
            self.web_element.inputElement(
                "#\\39 158 > input", self.app.joboffer.hourly_rate
            ),
            self.web_element.radioElement(
                ...
                label="Was wage converted from monthly or yearly...?",
            ),
        ]
    ...
    def work_location(self):
        ...
        for location in work_locations:
            ...
            business_activities = self.web_element.areatextElement(
                "#\\39 164 > textarea", self.app.general.business_intro
            )
