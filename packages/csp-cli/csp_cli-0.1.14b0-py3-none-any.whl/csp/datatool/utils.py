...
class Entity:
    ...
    def get_dataset(self):
        ...
        connections_path = os.path.join(abs_path, "connections.json")
        connection_categories_path = os.path.join(abs_path, "connectionCategories.json")
        ...
        if os.path.exists(connections_path) and os.path.exists(connection_categories_path):
            self.connections_data = JsonLoad(connections_path).data
            self.connection_categories_data = JsonLoad(connection_categories_path).data
