...
@click.option("-t", "--task", type=click.Choice(["obj_det", "text_entity_extra", "text_entity_relation_extra"]),
...
@click.option("-f", "--form", type=str, help="the dataset type. In task obj_det it should be voc or coco case insensitive")
...
@click.option("-g", "--gold_file", prompt="The gold json file. But in task 'text_entity_relation_extra' and 'text_entity_extra' should be a folder. In the task 'obj_det', it must be type of coco",
              help="The gold json file. But in task 'text_entity_relation_extra' and 'text_entity_extra' should be a folder. In the task 'obj_det', it must be type of coco", required=True)
@click.option("-t", "--task", type=click.Choice(["obj_det", "text_entity_extra", "text_entity_relation_extra"]),
              prompt="the task type", help="the task type", required=True)
...
@click.option("-t", "--task", type=click.Choice(["obj_det"]),
              prompt="the task type", help="the task type", required=True)
