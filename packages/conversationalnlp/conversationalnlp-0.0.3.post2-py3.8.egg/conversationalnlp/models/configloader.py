...
class ConfigLoader:
    ...
    def usecuda(self) -> str:
        ...
        if self.config["DEFAULT"].getboolean("usecuda") is True and torch.cuda.is_available():

            return "cuda"

        elif self.config["DEFAULT"].getboolean("usecuda") is True and torch.cuda.is_available():
