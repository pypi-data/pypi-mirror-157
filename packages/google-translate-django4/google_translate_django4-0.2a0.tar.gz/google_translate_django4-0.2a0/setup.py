...
setup(
  ...
  version = '0.2a',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/webprice/google_translate_django4/archive/refs/tags/v_0.2a.tar.gz',    # I explain this later on
