...
setup(
  name = 'google_translate_django4',         # How you named your package folder (MyLib)
  ...
  download_url = 'https://github.com/webprice/google_translate_django4/archive/refs/tags/v_0.1.tar.gz',    # I explain this later on
