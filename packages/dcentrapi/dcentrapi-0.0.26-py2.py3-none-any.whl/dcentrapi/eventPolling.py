...
class EventPolling(Base):
    ...
    def get_events_sum_of_values_in_range(self, contract_address, event_name, field_name, collection_name, start_time, end_time):
    ...
    def get_collection_users_in_time_range(self, collection_name, start_time, end_time):
        url = self.url + "event_polling/users_in_time_range"
        data = {
            "collection_name": collection_name,
            "start_time": start_time,
            "end_time": end_time
