...
def main():
    ...
    rewards_parser = commands.add_parser('rewards', 'Reward management')
    ...
    rewards_action = rewards_parser.add_mutually_exclusive_group(required=True)
    rewards_action.add_argument('add')
