...
class TerrariaPCPlayer:
	...
	def __init__(self, path: str = None, version: int = None):
		...
		self.dyes: list[Item] = []
		self.inventory: list[list[Item | InventoryItem]] = []
		self.coins: list[Item] = []
		self.ammo: list[Item] = []
		self.misc_equips: list[Item] = []
		self.misc_dyes: list[Item] = []
		self.piggy_bank: list[Item] = []
		self.safe: list[list[int]] = []
		self.defenders_forge: list[list[int]] = []
		self.void_vault: list[list[int]] = []
		...
		self.last_time_player_was_saved: datetime = datetime(1, 1, 1)
