...
class Node(object):
    ...
    def has_majority(self, count):
        ...
        :param count: A number of consensus nodes
        :type count: int
    ...
    def on_message(self, msg):
        ...
        with self.lock:
            ...
            if msg.procedure == MESSAGE_APPEND_ENTRIES:
            ...
            elif msg.procedure == MESSAGE_VOTE_REQUEST:
            ...
            elif msg.procedure == MESSAGE_VOTE_RESPONSE:
                response = self.state.on_vote_response(self, msg)

            elif msg.procedure == MESSAGE_APPEND_RESPONSE:
