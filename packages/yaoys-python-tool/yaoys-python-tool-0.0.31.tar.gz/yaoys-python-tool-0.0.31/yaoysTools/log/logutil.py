...
class mylog(object):
    ...
    def __init__(self, log_name='log', log_path=None, log_level=None,
        ...
        __format_str = 'time:%(asctime)s -log_name:%(name)s -level:%(levelname)-s  -chain:%(chain)s -log_filename:%(log_filename)s  -codename:%(codename)s -linenumber:%(linenumber)d line - %(lineno)d line -message: %(message)s'
...
def log_info(message, my_logger=None):
    ...
    my_logger.info(message, extra={'chain': get_chain(), 'log_filename': _get_file_name(), 'codename': _get_code_co_name(), 'linenumber': _get_code_line_number()})
    my_logger.handlers = []
...
def log_error(message, my_logger=None):
    ...
    my_logger.error(message, extra={'chain': get_chain(), 'log_filename': _get_file_name(), 'codename': _get_code_co_name(), 'linenumber': _get_code_line_number()})
    my_logger.handlers = []
...
def log_warn(message, my_logger=None):
    ...
    my_logger.warning(message, extra={'chain': get_chain(), 'log_filename': _get_file_name(), 'codename': _get_code_co_name(), 'linenumber': _get_code_line_number()})
    my_logger.handlers = []
...
def log_debug(message, my_logger=None):
    ...
    my_logger.debug(message, extra={'chain': get_chain(), 'log_filename': _get_file_name(), 'codename': _get_code_co_name(), 'linenumber': _get_code_line_number()})
    my_logger.handlers = []
