# 2022.6.29 , cp from cikuu/api/uvirun/textacy-fastapi.py 
#uvicorn textacy-fastapi:app --reload --port 80 --host 0.0.0.0
import json,os,uvicorn,textacy,spacy,fastapi
if not 'app' in globals(): 	app	 = fastapi.FastAPI()
if not hasattr(spacy, 'nlp'): spacy.nlp  = spacy.load('en_core_web_sm')

@app.get('/textai/keyword_in_context')
