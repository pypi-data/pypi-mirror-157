# 2022.6.30  
import json,os,re, requests,traceback,fire, time,math,collections, hashlib,uvicorn,os,fastapi, platform, fastapi
from util import likelihood
import pandas as pd
if not 'app' in globals(): 	app	 = fastapi.FastAPI()

import requests_cache
requests_cache.install_cache('cos_cache') # walk over, to load all, to fill the cache , to be used offline 
