...
@app.get('/gensim/most_similar_by_word')
...
@app.get('/gensim/similarity/words')
...
@app.post('/gensim/most_similar_by_vec')
...
@app.post('/gensim/most_similar_by_pos_neg')
