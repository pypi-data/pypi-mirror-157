function gdev,par,dp,X=x,Y=y,ERR=err,th=th,noderiv=noderiv

;  This function drives gfunc
...
if (n_params() eq 0) or (nx eq 0) or (ny eq 0) or (nerr eq 0) or $
  ...
  print,'Syntax - dev=gdev(par,dp,X=x,Y=y,ERR=err,th=th,/noderiv)'
...
th = gfunc(x,par,dp,noderiv=noderiv)
return,(y-th)/err
