...
from .client import client_authorization_header, REGISTER_SPECIFICATION_QUERY

def save_specification(client):
  """
    ...
    (async () => {{
      ...
      const res = await fetch(
        ...
        {{
          method: 'POST',
          headers: {{
            'authorization': {json.dumps(client_authorization_header(client))},
