...
class ClusterDefaultConfig(object):
    ...
    def __init__(self, cluster_network_cidr=None, cluster_network_host_prefix=None, inactive_deletion_hours=None, service_network_cidr=None, ntp_source=None, cluster_networks_ipv4=None, cluster_networks_dualstack=None, service_networks_ipv4=None, service_networks_dualstack=None):  # noqa: E501
