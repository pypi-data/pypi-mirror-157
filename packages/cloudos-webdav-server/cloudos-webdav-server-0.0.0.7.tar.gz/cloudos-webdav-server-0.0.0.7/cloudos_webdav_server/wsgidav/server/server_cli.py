...
from cloudos_webdav_server.wsgidav.default_conf import DEFAULT_CONFIG, DEFAULT_VERBOSE
from cloudos_webdav_server.wsgidav.fs_dav_provider import FilesystemProvider
from cloudos_webdav_server.wsgidav.wsgidav_app import WsgiDAVApp
from cloudos_webdav_server.wsgidav.xml_tools import use_lxml
...
def _run_ext_wsgiutils(app, config, _server):
    ...
    from cloudos_webdav_server.wsgidav.server import ext_wsgiutils_server
...
def run(cfg):
    cli_opts, config = _init_config(cfg)
