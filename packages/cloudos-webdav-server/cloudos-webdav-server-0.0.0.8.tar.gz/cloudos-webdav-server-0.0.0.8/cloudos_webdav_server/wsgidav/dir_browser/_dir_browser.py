...
from cloudos_webdav_server.wsgidav.dav_error import HTTP_MEDIATYPE_NOT_SUPPORTED, HTTP_OK, DAVError
from cloudos_webdav_server.wsgidav.mw.base_mw import BaseMiddleware
from cloudos_webdav_server.wsgidav.util import safe_re_encode
import cloudos_webdav_server
htdocs_dir=os.path.join(os.path.dirname(cloudos_webdav_server.__file__),"data/htdocs")
...
class WsgiDavDirBrowser(BaseMiddleware):
    ...
    def __init__(self, wsgidav_app, next_app, config):
        ...
        if htdocs_path:
            ...
            self.htdocs_path = htdocs_dir
            # print("htdocs_path:",self.htdocs_path)
