...
from cloudos_webdav_server.wsgidav.dav_error import (
    HTTP_BAD_REQUEST,
    HTTP_CREATED,
    HTTP_NO_CONTENT,
    HTTP_NOT_MODIFIED,
...
from cloudos_webdav_server.wsgidav.xml_tools import etree, is_etree_element, make_sub_element, xml_to_bytes
...
def init_logging(config):
    ...
    """
    from cloudos_webdav_server.wsgidav.default_conf import DEFAULT_LOGGER_DATE_FORMAT, DEFAULT_LOGGER_FORMAT
