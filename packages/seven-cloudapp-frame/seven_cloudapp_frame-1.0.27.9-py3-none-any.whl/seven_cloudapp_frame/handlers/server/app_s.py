...
@LastEditTime: 2022-06-27 15:49:10
...
class StoreAssetLogListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        asset_base_model = AssetBaseModel(context=self)
        page_list, total = asset_base_model.get_store_asset_log_list(app_id, asset_type, page_size, page_index, store_id, store_name, asset_object_id, start_date, end_date, source_type, source_object_id, field, is_cache=False, operate_type=operate_type)
        ref_params = {}
