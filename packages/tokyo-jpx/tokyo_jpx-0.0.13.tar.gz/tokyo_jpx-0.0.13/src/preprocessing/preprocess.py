...
def df_transform(prices, options=None, financials=None, trades=None, secondary_prices=None):
    pass


def get_data(folder='train_files', root_path=None, supp_files='supplemental_files'):
    """
