...
ax1.set_title("Power of 6 MHz sideband in PRC vs PR RoC")
...
ax1.legend()
fig.savefig("plots/sb-0-prc-beam-parameters-overview.pdf")
...
ax1.set_ylabel("Power [W]")
ax1.legend()
fig.savefig("plots/sb-1-prc-beam-parameters-overview-maxtem20.pdf")
...
ax1.set_ylabel("Power [W]")
ax1.legend()
fig.savefig("plots/sb-2-prc-beam-parameters-short-convergence.pdf")


# %%
x = np.abs(outs[0].x1 - outs[0].x1[0])
fig, ax1 = plt.subplots()
ax1.set_title("Convergence of long cavity with higher maxtem")
ax1.plot(x, outs5[0]["pPR"], "ok", label="with long cavities, q fixed", lw=4)
...
ax1.set_ylabel("Power [W]")
ax1.legend()
fig.savefig("plots/sb-3-prc-beam-parameters-long-convergence.pdf")
