...
from pine.exceptions import CommandFailedError, InvalidRemoteException, AppNotInstalledError
...
def is_valid_melon_branch(melon_path:str, melon_branch:str):
	...
	if melon_branch:
		try:
			...
			raise InvalidRemoteException(f"Invalid melon path: {melon_path}")
