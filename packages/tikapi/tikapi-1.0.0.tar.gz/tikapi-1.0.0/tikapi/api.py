...
def Rests(options: dict):
	...
	global_options = {"base":"https://api.tikapi.io","sandboxBase":"http://sandbox.localhost:5000","headers":{"User-Agent":"Rests Python (v1.0.3)"},"params":{"apiKey":{"name":"X-API-KEY","required":True,"location":"headers","validate":"^[a-zA-Z0-9]{10,}$","example":"DemoAPIKeyTokenSeHYGXDfd4SFD320Sc39Asd0Sc39Asd4s","help":"The TikAPI API Key is required for all requests","$initsOnly":True}},"values":{},"on_error":None,"on_success":None,"on_request":None,"proxies":None,"__$root__":"API","$other":{"openapi":{"packageName":"tikapi","fields":{"security":[{"apiKey":[]}],"responses":{"400":{"$ref":"./responses/errors/400.yaml"},"403":{"$ref":"./responses/errors/403.yaml"}},"parameters":[]}}}}
	...
	class Public(Rests.BaseClass):
		...
		def explore(cls, count: int = Default(30), country: str = None, **otherParams) -> APIResponse:
			...
			return wrap({"help":"Get trending posts","comment":"Get a list of recommended posts from the *For You* section.","path":"/public/explore","params":{"count":{"example":30,"default":30,"max":30,"type":"number","help":"Maximum amount of items for one request","validate":"^[0-9]{1,2}$"}},"method":"GET"}, cls.__get_options__(), "Public.explore")(count=count, country=country, **otherParams)
	...
	class UserPosts(Rests.BaseClass):
		...
		def likes(cls, count: int = Default(30), secUid: str = None, cursor: str = None, **otherParams) -> APIResponse:
			...
			return wrap({"help":"Get liked posts","comment":"Get current user liked posts, or someone elses by providing the `secUid` parameter.","path":"/user/likes","params":{"count":{"example":30,"default":30,"max":30,"type":"number","help":"Maximum amount of items for one request","validate":"^[0-9]{1,2}$"},"secUid":{"validate":"^(.*?){30,}$","help":"The TikTok user secUid","type":"string","example":"MS4wLjABAAAAsHntXC3s0AvxcecggxsoVa4eAiT8OVafVZ4OQXxy-9htpnUi0sOYSr0kGGD1Loud"},"cursor":{"help":"The starting point of the items list. Returned in every response, should be included in the next request for iteration","type":"string","validate":"^[0-9]+$"}},"$other":{"openapi":{"fields":{"security":[{"apiKey":[],"accountKey":["search"]}]}}},"method":"GET"}, cls.__get_options__(), "UserPosts.likes")(count=count, secUid=secUid, cursor=cursor, **otherParams)
		...
		def unlike(cls, media_id: str = None, **otherParams) -> APIResponse:
			...
			return wrap({"help":"Unlike a video","comment":"*This endpoint is only available to trusted customers. Learn more at\nhttps://helpdesk.tikapi.io/portal/en/kb/articles/how-can-i-get-access-to-special-endpoints*\n\n","path":"/user/like","method":"POST","enctype":"json","params":{"media_id":{"help":"The video ID. Can also be a short TikTok link (e.g. vm.tiktok.com/UwU)","type":"string","validate":"^([0-9]+|https?://vm.tiktok.com/[a-zA-Z0-9]+/?)$","required":True,"example":"7109178205151464746"}},"$other":{"openapi":{"fields":{"security":[{"apiKey":[],"accountKey":["media_actions"]}]}}}}, cls.__get_options__(), "UserPosts.unlike")(media_id=media_id, **otherParams)
	...
	class UserLive(Rests.BaseClass):
		...
		def info(cls, room_id: str = None, **otherParams) -> APIResponse:
			...
			return wrap({"help":"Get live information","comment":"Get information about a live video. <br/>You can use this for any user\n\t\t\t\tthat has an open live video. There is a `roomId` parameter included when\n\t\t\t\tfetching profile information about users.","path":"/user/live/check","params":{"room_id":{"help":"The Live room ID","type":"string","example":"7112492061034646278","required":True}},"method":"GET"}, cls.__get_options__(), "UserLive.info")(room_id=room_id, **otherParams)
		...
		def stats(cls, room_id: str = None, **otherParams) -> APIResponse:
			...
			return wrap({"help":"Get live statistics","comment":"Get statistics for the current user live video, after it has ended.","path":"/user/live/stats","params":{"room_id":{"help":"The Live room ID","type":"string","example":"7112492061034646278","required":True}},"method":"GET"}, cls.__get_options__(), "UserLive.stats")(room_id=room_id, **otherParams)
	...
	class User(Rests.BaseClass):
		...
		def notifications(cls, filter: str = Default("all"), count: int = Default(30), max_time = None, min_time = None, **otherParams) -> APIResponse:
			...
			return wrap({"help":"Get notifications","comment":"Get current user recent notifications.\n\t\t\t\n\t\t\t`*Note: The full notifications history might not be achievable due to limitations by TikTok*` \n\t\t\t","path":"/user/notifications","params":{"filter":{"default":"all","help":"Filter notifications by type","type":"string","in":["all","likes","comments","mentions","followers"]},"count":{"example":30,"default":30,"max":30,"type":"number","help":"Maximum amount of items for one request","validate":"^[0-9]{1,2}$"},"max_time":{"name":"max_time","help":"Returned in every response, should be included in the next request for iteration.","validate":"^[0-9]+$"},"min_time":{"help":"Returned in every response, should be included in the next request for iteration.","name":"min_time","validate":"^[0-9]+$"}},"$other":{"openapi":{"fields":{"security":[{"apiKey":[],"accountKey":["view_profile"]}],"tags":["Profile"]}}},"method":"GET"}, cls.__get_options__(), "User.notifications")(filter=filter, count=count, max_time=max_time, min_time=min_time, **otherParams)
		...
		def unfollow(cls, username: str = None, user_id: str = None, **otherParams) -> APIResponse:
			...
			return wrap({"help":"Unfollows an user","comment":"*This endpoint is only available to trusted customers. Learn more at\nhttps://helpdesk.tikapi.io/portal/en/kb/articles/how-can-i-get-access-to-special-endpoints*\n\n","path":"/user/unfollow","method":"POST","enctype":"json","params":{"username":{"help":"The TikTok user username","validate":"^([a-zA-Z0-9_.]+|https?://vm.tiktok.com/[a-zA-Z0-9]+/?)$","type":"string","required":True,"example":"lilyachty"},"user_id":{"help":"The TikTok user ID","type":"string","validate":"^[0-9]+$","required":True,"example":"6569595380449902597"}},"$other":{"openapi":{"fields":{"tags":["Followers"],"security":[{"apiKey":[],"accountKey":["follow_actions"]}]}}}}, cls.__get_options__(), "User.unfollow")(username=username, user_id=user_id, **otherParams)
	
		posts = Rests.UserPosts
		@classmethod
		def conversations(cls, cursor: str = None, **otherParams) -> APIResponse:
			'''
				Get user conversations 
			'''
			
			return wrap({"path":"/user/conversations","help":"Get user conversations","comment":"**Premium**<img title='Only Business and Enterprise subscriptions can access this\nendpoint' style='margin-bottom: -3px;cursor: help;'\nsrc='/assets/img/star.png' width='18px'><br/>\nGet a list of current user conversations including the latest messages","params":{"cursor":{"help":"The starting point of the items list. Returned in every response, should be included in the next request for iteration","type":"string","validate":"^[0-9]+$"}},"$other":{"openapi":{"fields":{"tags":["Messages"],"security":[{"apiKey":[],"accountKey":["view_messages"]}]}}},"method":"GET"}, cls.__get_options__(), "User.conversations")(cursor=cursor, **otherParams)
	
		@classmethod
		def messages(cls, conversation_id = None, conversation_short_id = None, cursor: str = None, limit = None, **otherParams) -> APIResponse:
			'''
				Get user messages 
			'''
			
			return wrap({"path":"/user/messages","help":"Get user messages","comment":"**Premium**<img title='Only Business and Enterprise subscriptions can access this\nendpoint' style='margin-bottom: -3px;cursor: help;'\nsrc='/assets/img/star.png' width='18px'><br/>\nGet full messages list of a conversation","params":{"conversation_id":{"help":"The conversation ID","required":True,"example":"0:1:684574219823284956:69402435203845897564"},"conversation_short_id":{"help":"The additional conversation short ID (TikTok uses two different ID's for some reason)","required":True,"example":"6940245147502654884"},"cursor":{"help":"The starting point of the items list. Returned in every response, should be included in the next request for iteration","type":"string","validate":"^[0-9]+$"},"limit":{"validate":"^[0-9]{1,2}$"}},"$other":{"openapi":{"fields":{"tags":["Messages"],"security":[{"apiKey":[],"accountKey":["view_messages"]}]}}},"method":"GET"}, cls.__get_options__(), "User.messages")(conversation_id=conversation_id, conversation_short_id=conversation_short_id, cursor=cursor, limit=limit, **otherParams)
