...
class DriverlessAIMOJO:
    def __init__(self, feature_set, mojo):
        warnings.warn(
            "DriverlessAIMOJO data source has been deprecated and will be "
            "removed in the next major release. Please use transformations "
            "instead.",
            DeprecationWarning,
        )
...
class SparkPipeline:
    def __init__(self, feature_set, pipeline):
        warnings.warn(
            "SparkPipeline data source has been deprecated and will be "
            "removed in the next major release. Please use transformations "
            "instead.",
            DeprecationWarning,
        )
...
class JoinedFeatureSets:
    def __init__(self, left, right, join_key):
        warnings.warn(
            "Join data source has been deprecated and will be "
            "removed in the next major release. Please use transformations "
            "instead.",
            DeprecationWarning,
        )
