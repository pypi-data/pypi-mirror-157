        ...
        while True:
            ...
            if parseChar is 0xF0:
                ...
                if ins is 0x63:
                    ...
                    if len(self.__serial_buf) < 20:
                        self.__serial_buf.extendleft([0xF0, 0x01])
                        continue
                    ...
                    if id == 0x09:
                        ...
                        self.__gyro_data.angleX = (data[0] + ((data[1] & 0x01) << 7)) * (-1 if ((data[1] >> 4 & 0x01) == 1) else 1)
                        self.__gyro_data.angleY = (data[2] + ((data[3] & 0x01) << 7)) * (-1 if ((data[3] >> 4 & 0x01) == 1) else 1)
                        self.__gyro_data.angleZ = (data[4] + ((data[5] & 0x01) << 7)) * (-1 if ((data[5] >> 4 & 0x01) == 1) else 1)

                        self.__gyro_data.gyroX = (data[6] + ((data[7] & 0x01) << 7)) * (-1 if ((data[7] >> 4 & 0x01) == 1) else 1)
                        self.__gyro_data.gyroX = (data[8] + ((data[9] & 0x01) << 7)) * (-1 if ((data[9] >> 4 & 0x01) == 1) else 1)
