...
class TestLayerApi(unittest.TestCase):
    ...
    def test_2_arcgisearth_layer_id_get(self):
        ...
        self.assertEqual(TestLayerApi.layer_id, layer_info["id"])
    ...
    def test_1_arcgisearth_layer_post(self):
        ...
        TestLayerApi.layer_id = results["id"]
        self.assertIsNotNone(TestLayerApi.layer_id)
        time.sleep(2)
