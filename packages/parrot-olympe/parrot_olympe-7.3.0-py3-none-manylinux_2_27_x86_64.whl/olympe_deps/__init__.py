...
vmeta_location_delta.argtypes = [POINTER_T(struct_vmeta_location), POINTER_T(struct_vmeta_location), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_double), POINTER_T(ctypes.c_double)]
...
vmeta_frame_ltic.argtypes = [POINTER_T(struct_vmeta_frame), POINTER_T(struct_vmeta_location), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_float), POINTER_T(ctypes.c_float)]
...
__all__ = \
    ...
    'VMETA_STRM_SDES_KEY_BUILD_ID', 'VMETA_STRM_SDES_KEY_CAMERA_TYPE',
    'VMETA_STRM_SDES_KEY_COMMENT', 'VMETA_STRM_SDES_KEY_COPYRIGHT',
    ...
    'vmeta_frame_write', 'vmeta_location_delta',
