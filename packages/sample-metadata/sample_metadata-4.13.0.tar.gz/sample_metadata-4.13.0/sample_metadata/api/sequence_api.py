...
class SequenceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.update_sequence_from_external_sample_and_type_async = async_wrap(self.update_sequence_from_external_sample_and_type)
        self.update_sequence_from_external_sample_and_type_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v1/sequence/external_sample_id/{external_sample_id}/{project}/{sequence_type}',
                'operation_id': 'update_sequence_from_external_sample_and_type',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def update_sequence_from_external_sample_and_type(
        self,
        external_sample_id,
        sequence_type,
        project,
        ...
        **kwargs
        ...
        """Update Sequence From External Id And Type  # noqa: E501

        Update the latest sequence by sample_id and sequence type  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_sequence_from_external_sample_and_type(external_sample_id, sequence_type, project, sequence_update_model, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['sequence_update_model'] = \
            sequence_update_model
        return self.update_sequence_from_external_sample_and_type_endpoint.call_with_http_info(**kwargs)
