...
class punctuate_lasla(lasla_pos_txt):
    ...
    def get_atts(self):
        self.kind = ''
        self.phi_lst = to.from_txt2lst(f'{phi_fold}petronius/satyrica')
        # if self.kind != 'all':
        #     self.lasla_db2 = pi.open_pickle(f'{fold}lasla_db2')
        # self.ltxt = self.lasla_db2['Petronius']['PetroniusSatiricon_PetronSa']
        file = f'{lfold}lasla2/PetroniusSatiricon_PetronSa'
