...
class Weather:
    ...
    def get_weather_response(self):
        ...
        if 'coord' not in self.location:
            print('Please, set a location using wea.py -l {location} or provide one as an argument: wea {location}')
            sys.exit()
        elif not api_key:
            print('Please, provide your OpenWeather API key. You can get one for free with an OpenWeather account: '
    ...
    def handle_response(self):
        ...
        if not self.response_list:
            print('Could not find API\'s response. Did you use Weather.get_weather_response()?')
            sys.exit()
    ...
    def print_weather(self):
        ...
        if not self.current and not self.forecast:
            print('Could not find any weather report to print. Did you use Weather.handle_response()?')
            sys.exit()
