...
setup(
    ...
    package_data = {'meteor_diceware' : ['./init.sql' , './actual_diceware.txt' , './snowflake.pdf']} , 
    exclude_package_data={ 'meteor_diceware' : ['./requitements.txt' , './db.sqlite3' , './dicecalls.proc.py'] } ,  
    project_urls={
