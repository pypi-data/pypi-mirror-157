...
class NoticeApi(object):
    ...
    def get_webui_notice(self, **kwargs):  # noqa: E501
        """get WebUI notice  # noqa: E501

        获取设备状态如授权状态、密码状态等相关通知  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_webui_notice(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_webui_notice_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_webui_notice_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_webui_notice_with_http_info(self, **kwargs):  # noqa: E501
        """get WebUI notice  # noqa: E501

        获取设备状态如授权状态、密码状态等相关通知  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_webui_notice_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_webui_notice" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ConfigNotice',  # noqa: E501
