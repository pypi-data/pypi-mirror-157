...
class ConfigLinkWanMonitors(object):
    ...
    def __init__(self, monitor=None, target_host=None):  # noqa: E501
        """ConfigLinkWanMonitors - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def monitor(self):
        """Gets the monitor of this ConfigLinkWanMonitors.  # noqa: E501

        必选参数；引用的链路监视器名称  # noqa: E501

        :return: The monitor of this ConfigLinkWanMonitors.  # noqa: E501
        :rtype: str
        """
    ...
    def monitor(self, monitor):
        """Sets the monitor of this ConfigLinkWanMonitors.

        必选参数；引用的链路监视器名称  # noqa: E501

        :param monitor: The monitor of this ConfigLinkWanMonitors.  # noqa: E501
        :type: str
        """
        if monitor is None:
    ...
    def target_host(self):
        """Gets the target_host of this ConfigLinkWanMonitors.  # noqa: E501

        必选参数；检测目标主机  # noqa: E501

        :return: The target_host of this ConfigLinkWanMonitors.  # noqa: E501
        :rtype: str
        """
    ...
    def target_host(self, target_host):
        """Sets the target_host of this ConfigLinkWanMonitors.

        必选参数；检测目标主机  # noqa: E501

        :param target_host: The target_host of this ConfigLinkWanMonitors.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigLinkWanMonitors, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigLinkWanMonitors):
            return False
