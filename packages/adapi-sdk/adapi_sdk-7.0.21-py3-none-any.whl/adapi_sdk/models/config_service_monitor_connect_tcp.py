...
class ConfigServiceMonitorConnectTcp(object):
    ...
    @property
    def name(self):
        """Gets the name of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        必选参数；指定监视器的名称, 在配置中必须唯一。  # noqa: E501

        :return: The name of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ConfigServiceMonitorConnectTcp.

        必选参数；指定监视器的名称, 在配置中必须唯一。  # noqa: E501

        :param name: The name of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；用来对此配置增加额外的备注。  # noqa: E501

        :return: The description of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ConfigServiceMonitorConnectTcp.

        可选参数；用来对此配置增加额外的备注。  # noqa: E501

        :param description: The description of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        只读参数；监视器类型。  # noqa: E501

        :return: The type of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ConfigServiceMonitorConnectTcp.

        只读参数；监视器类型。  # noqa: E501

        :param type: The type of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timeout(self):
        """Gets the timeout of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；设置监视超时时间。  # noqa: E501

        :return: The timeout of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this ConfigServiceMonitorConnectTcp.

        可选参数；设置监视超时时间。  # noqa: E501

        :param timeout: The timeout of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: int
        """
    ...
    @property
    def interval(self):
        """Gets the interval of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；设置监视间隔时间。  # noqa: E501

        :return: The interval of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: int
        """
    ...
    def interval(self, interval):
        """Sets the interval of this ConfigServiceMonitorConnectTcp.

        可选参数；设置监视间隔时间。  # noqa: E501

        :param interval: The interval of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: int
        """
    ...
    @property
    def host(self):
        """Gets the host of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；支持ip地址和*;默认为*，表示监视节点池中的地址；当启用gateway_detect时必须指定ip地址  # noqa: E501

        :return: The host of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this ConfigServiceMonitorConnectTcp.

        可选参数；支持ip地址和*;默认为*，表示监视节点池中的地址；当启用gateway_detect时必须指定ip地址  # noqa: E501

        :param host: The host of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def port(self):
        """Gets the port of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；指定监视端口；取值范围[0,65535]，默认为0，表示使用节点池中节点的端口  # noqa: E501

        :return: The port of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this ConfigServiceMonitorConnectTcp.

        可选参数；指定监视端口；取值范围[0,65535]，默认为0，表示使用节点池中节点的端口  # noqa: E501

        :param port: The port of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: int
        """
    ...
    @property
    def debug_mode(self):
        """Gets the debug_mode of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；调试模式开关，disable表示禁用，enable表示启用；默认禁用。  # noqa: E501

        :return: The debug_mode of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
    ...
    def debug_mode(self, debug_mode):
        """Sets the debug_mode of this ConfigServiceMonitorConnectTcp.

        可选参数；调试模式开关，disable表示禁用，enable表示启用；默认禁用。  # noqa: E501

        :param debug_mode: The debug_mode of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
    ...
    def gateway_detect(self):
        """Gets the gateway_detect of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；透明监控开关，disable表示禁用，enable表示启用；默认禁用。  # noqa: E501

        :return: The gateway_detect of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_detect(self, gateway_detect):
        """Sets the gateway_detect of this ConfigServiceMonitorConnectTcp.

        可选参数；透明监控开关，disable表示禁用，enable表示启用；默认禁用。  # noqa: E501

        :param gateway_detect: The gateway_detect of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
        allowed_values = ["ENABLE", "DISABLE"]  # noqa: E501
    ...
    def send_content(self):
        """Gets the send_content of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；指定监视发送内容。  # noqa: E501

        :return: The send_content of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
    ...
    def send_content(self, send_content):
        """Sets the send_content of this ConfigServiceMonitorConnectTcp.

        可选参数；指定监视发送内容。  # noqa: E501

        :param send_content: The send_content of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
    ...
    def receive_cache_size(self):
        """Gets the receive_cache_size of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；指定接收缓冲区大小。  # noqa: E501

        :return: The receive_cache_size of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: int
        """
    ...
    def receive_cache_size(self, receive_cache_size):
        """Sets the receive_cache_size of this ConfigServiceMonitorConnectTcp.

        可选参数；指定接收缓冲区大小。  # noqa: E501

        :param receive_cache_size: The receive_cache_size of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: int
        """
    ...
    def receive_content_match(self):
        """Gets the receive_content_match of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；指定接收匹配内容  # noqa: E501

        :return: The receive_content_match of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
    ...
    def receive_content_match(self, receive_content_match):
        """Sets the receive_content_match of this ConfigServiceMonitorConnectTcp.

        可选参数；指定接收匹配内容  # noqa: E501

        :param receive_content_match: The receive_content_match of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
    ...
    def reverse_result(self):
        """Gets the reverse_result of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；指定是否做反向匹配。enable表示反向匹配,disable表示正向匹配,默认disable。  # noqa: E501

        :return: The reverse_result of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
    ...
    def reverse_result(self, reverse_result):
        """Sets the reverse_result of this ConfigServiceMonitorConnectTcp.

        可选参数；指定是否做反向匹配。enable表示反向匹配,disable表示正向匹配,默认disable。  # noqa: E501

        :param reverse_result: The reverse_result of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
        allowed_values = ["ENABLE", "DISABLE"]  # noqa: E501
    ...
    def send_content_before_disconnect(self):
        """Gets the send_content_before_disconnect of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数；指定断开之前发送内容。  # noqa: E501

        :return: The send_content_before_disconnect of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
    ...
    def send_content_before_disconnect(self, send_content_before_disconnect):
        """Sets the send_content_before_disconnect of this ConfigServiceMonitorConnectTcp.

        可选参数；指定断开之前发送内容。  # noqa: E501

        :param send_content_before_disconnect: The send_content_before_disconnect of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
    ...
    def hexadecimal_mode(self):
        """Gets the hexadecimal_mode of this ConfigServiceMonitorConnectTcp.  # noqa: E501

        可选参数; 十六进制模式开关,enable表示启用,disable表示禁用,默认为disable  # noqa: E501

        :return: The hexadecimal_mode of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :rtype: str
        """
    ...
    def hexadecimal_mode(self, hexadecimal_mode):
        """Sets the hexadecimal_mode of this ConfigServiceMonitorConnectTcp.

        可选参数; 十六进制模式开关,enable表示启用,disable表示禁用,默认为disable  # noqa: E501

        :param hexadecimal_mode: The hexadecimal_mode of this ConfigServiceMonitorConnectTcp.  # noqa: E501
        :type: str
        """
        allowed_values = ["ENABLE", "DISABLE"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigServiceMonitorConnectTcp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigServiceMonitorConnectTcp):
            return False
