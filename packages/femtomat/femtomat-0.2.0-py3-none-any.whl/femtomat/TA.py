...
class TA_Pre:
    ...
    def __init__(self, Data):
        '''
        Upon initialization the ``check_w_orientation`` function is called, to ensure numerical order wavelengths. The raw data is then separated into TA data ``D`` and its corresponding wavelengths ``w`` and timedelays ``t``.
        
        :param Data: A numpy object in the form of the raw TA data without any preprocessing.
