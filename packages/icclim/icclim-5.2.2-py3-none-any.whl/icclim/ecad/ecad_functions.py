...
def hd17(config: IndexConfig) -> DataArray:
    return _compute_threshold_index(
        da=config.tas.study_da,
        threshold=17.0 if config.scalar_thresholds is None else config.scalar_thresholds,
        freq=config.frequency,
...
def su(config: IndexConfig) -> DataArray:
    return _compute_threshold_index(
        da=config.tasmax.study_da,
        threshold=25.0 if config.scalar_thresholds is None else config.scalar_thresholds,
        freq=config.frequency,
...
def tr(config: IndexConfig) -> DataArray:
    return _compute_threshold_index(
        da=config.tasmin.study_da,
        threshold=20.0 if config.scalar_thresholds is None else config.scalar_thresholds,
        freq=config.frequency,
