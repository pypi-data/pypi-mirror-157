...
font_path = os.path.join ( "/usr/share/fonts/opentype/noto", "NotoSansCJK-Black.ttc" )  # 文字样式
...
def draw_img(bfversion):
    ...
    # 设置字体，如果没有，也可以不设置
    font = ImageFont.truetype ( r"/usr/share/fonts/opentype/noto/NotoSansCJK-Black.ttc", 38 )
