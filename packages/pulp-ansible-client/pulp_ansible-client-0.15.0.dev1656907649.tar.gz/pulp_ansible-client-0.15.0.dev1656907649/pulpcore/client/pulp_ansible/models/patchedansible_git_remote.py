...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, sock_read_timeout=None, download_concurrency=None, pulp_labels=None, max_retries=None, proxy_password=None, client_cert=None, tls_validation=None, proxy_url=None, password=None, proxy_username=None, client_key=None, url=None, connect_timeout=None, total_timeout=None, username=None, ca_cert=None, sock_connect_timeout=None, rate_limit=None, headers=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
