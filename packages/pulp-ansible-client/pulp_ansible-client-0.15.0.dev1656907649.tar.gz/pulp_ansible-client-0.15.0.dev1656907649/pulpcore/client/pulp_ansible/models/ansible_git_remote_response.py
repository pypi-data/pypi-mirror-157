...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_read_timeout=None, download_concurrency=None, pulp_labels=None, max_retries=None, client_cert=None, tls_validation=None, proxy_url=None, url=None, connect_timeout=None, total_timeout=None, pulp_created=None, ca_cert=None, sock_connect_timeout=None, rate_limit=None, headers=None, pulp_href=None, name=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
