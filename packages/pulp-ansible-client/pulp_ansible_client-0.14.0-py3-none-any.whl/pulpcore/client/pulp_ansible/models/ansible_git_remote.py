...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, password=None, connect_timeout=None, name=None, proxy_url=None, max_retries=None, sock_read_timeout=None, headers=None, download_concurrency=None, total_timeout=None, client_key=None, url=None, pulp_labels=None, sock_connect_timeout=None, proxy_username=None, ca_cert=None, username=None, tls_validation=None, proxy_password=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
