...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, connect_timeout=None, name=None, proxy_url=None, max_retries=None, sock_read_timeout=None, headers=None, download_concurrency=None, total_timeout=None, url=None, pulp_created=None, pulp_labels=None, sock_connect_timeout=None, ca_cert=None, tls_validation=None, pulp_href=None, pulp_last_updated=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
