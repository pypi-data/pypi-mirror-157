...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, url=None, max_retries=None, download_concurrency=None, pulp_last_updated=None, rate_limit=None, tls_validation=None, pulp_created=None, name=None, proxy_url=None, connect_timeout=None, client_cert=None, headers=None, sock_read_timeout=None, pulp_href=None, sock_connect_timeout=None, ca_cert=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
