...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, url=None, proxy_username=None, max_retries=None, download_concurrency=None, rate_limit=None, tls_validation=None, name=None, proxy_url=None, connect_timeout=None, client_cert=None, headers=None, sock_read_timeout=None, password=None, sock_connect_timeout=None, ca_cert=None, username=None, client_key=None, proxy_password=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
