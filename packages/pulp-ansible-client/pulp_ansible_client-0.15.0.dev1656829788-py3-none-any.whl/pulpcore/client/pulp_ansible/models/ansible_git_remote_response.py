...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, sock_read_timeout=None, total_timeout=None, rate_limit=None, client_cert=None, pulp_last_updated=None, max_retries=None, ca_cert=None, connect_timeout=None, download_concurrency=None, sock_connect_timeout=None, headers=None, tls_validation=None, pulp_labels=None, url=None, name=None, pulp_href=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
