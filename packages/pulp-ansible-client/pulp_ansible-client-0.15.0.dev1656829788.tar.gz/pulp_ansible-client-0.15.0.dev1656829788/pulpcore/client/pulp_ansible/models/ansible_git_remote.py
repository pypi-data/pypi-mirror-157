...
class AnsibleGitRemote(object):
    ...
    def __init__(self, sock_read_timeout=None, total_timeout=None, proxy_username=None, rate_limit=None, client_cert=None, max_retries=None, proxy_password=None, ca_cert=None, password=None, connect_timeout=None, client_key=None, username=None, download_concurrency=None, sock_connect_timeout=None, headers=None, tls_validation=None, pulp_labels=None, url=None, name=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
