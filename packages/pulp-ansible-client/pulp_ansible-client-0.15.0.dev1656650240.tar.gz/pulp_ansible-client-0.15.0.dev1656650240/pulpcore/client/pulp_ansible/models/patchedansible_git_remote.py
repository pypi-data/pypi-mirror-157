...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, ca_cert=None, total_timeout=None, name=None, pulp_labels=None, proxy_password=None, proxy_username=None, connect_timeout=None, client_cert=None, sock_connect_timeout=None, proxy_url=None, username=None, max_retries=None, tls_validation=None, rate_limit=None, url=None, sock_read_timeout=None, password=None, download_concurrency=None, headers=None, client_key=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
