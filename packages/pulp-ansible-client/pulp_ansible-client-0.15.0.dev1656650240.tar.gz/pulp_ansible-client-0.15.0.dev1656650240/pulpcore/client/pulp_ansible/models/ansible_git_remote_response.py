...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, ca_cert=None, total_timeout=None, name=None, pulp_labels=None, connect_timeout=None, client_cert=None, pulp_last_updated=None, sock_connect_timeout=None, proxy_url=None, max_retries=None, tls_validation=None, rate_limit=None, url=None, pulp_created=None, pulp_href=None, sock_read_timeout=None, download_concurrency=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
