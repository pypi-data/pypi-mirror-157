...
class BuilderLEDET:
    ...
    def loadParametersFromDataModel(self):
        ...
        self.setAttribute(self.Inputs,    'nT', self.model_data.CoilWindings.n_half_turn_in_group)
        ...
        self.setAttribute(self.Auxiliary, 'indexTstart', np.NaN)
        self.setAttribute(self.Auxiliary, 'indexTstop', np.NaN)
    ...
    def setSelfMutualInductances(self):
        '''
        Assign self-mutual inducance parameters (this is used whehn inductance calculation is not enabled
        :return:
        '''

        # Defining to which inductive block each half-turn belongs
        nHalfTurns = max(self.Auxiliary.strandToHalfTurn)
