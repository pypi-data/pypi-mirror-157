...
class Simulation3DLEDET(BaseModel):
    ...
    sim3D_f_cooling_down: Union[float, int] = None
    sim3D_f_cooling_up: Union[float, int] = None
    sim3D_f_cooling_left: Union[float, int] = None
    sim3D_f_cooling_right: Union[float, int] = None
