...
class TerraConf:
    ...
    def init_file_CI(self):
        token = os.getenv("CI_JOB_TOKEN")
        gitlab_username = os.getenv("GITLAB_USER_NAME")
        print("usernameee", gitlab_username)
        print("myyy path", os.path.expanduser(os.path.join("~/.terragit")))
        file = open(os.path.expanduser(os.path.join("~/.terragit")), mode='w')
        file.write(
            '{ "gitlab_token": "'+token+'",\n' +
