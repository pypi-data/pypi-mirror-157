...
class CBIGW:
    ...
    def __init__(self,m1=2e2*BC.M_sun,m2=1e3*BC.M_sun,r1=1e-5*BC.AU,r2=2e-5*BC.AU,Name='CBIG_SYS1'):
        ...
        self.info1={'Name of Binary Celestial Bodies':['BlackHole1','BlackHole2'],'Mass of Binary Celestial Bodies':[m1,m2],'Initial Orbit Radius':[r1,r2],}
    ...
    def __str__(self):
        ...
        str2.add_rows([['Celestial Body 1',self.M[0]/BC.M_sun,self.r_int[0]/BC.AU],['Celestial Body 2',self.M[1]/BC.M_sun,self.r_int[1]/BC.AU]])
        print(str1,str2,'\n')
    ...
    def Distance(self,T_now=200):
        '''
        ## Get the distance of binary celestial bodies at specified time
        '''
        if T_now>self.Coalescence_time:
            print('---Coalescence Time {}s Reached!, Current Time: {}s---'.format(self.Coalescence_time,T_now))
            return 0
