...
class PostgresqlAdapter:
    ...
    def __init__(self, dsn):
        ...
        try:
            ...
            self.cur = None
            logger.error(
                "Operational error occurred connecting to Postgresql database.", exc_info=True
            )
            ...
            self.cur = None
            logger.error(
                "unable to connect to Postgresql database. internal database connection error.",
                exc_info=True,
            )
    ...
    def execute_query(self, query_string):
        ...
        if self.cur is None:
            ...
            try:
                ...
                logging.error(
                    "Specified user does not have privilege to query the database table.",
                    exc_info=True,
                )
                return None
