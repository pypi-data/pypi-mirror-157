...
class PreProcessing:
    ...
    def __init__(  # noqa: C901
        ...
        if self.class_problem in ["regression"]:
            ...
            self.blueprint_step_selection_non_nlp["early_numeric_only_feature_selection"] = False
            self.blueprint_step_selection_non_nlp["numeric_binarizer_pca"] = False
            self.blueprint_step_selection_non_nlp["clustering_as_a_feature_dbscan"] = False
            self.blueprint_step_selection_non_nlp["clustering_as_a_feature_kmeans_loop"] = False
            self.blueprint_step_selection_non_nlp["clustering_as_a_feature_gaussian_mixture_loop"] = False
            self.blueprint_step_selection_non_nlp["pca_clustering_results"] = False
            self.blueprint_step_selection_non_nlp["autoencoder_outlier_detection"] = False
