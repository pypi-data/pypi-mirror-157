...
def main():
    parser = argparse.ArgumentParser(description='Python Indo')
    parser.add_argument('name', type=str, help='filename with extension .pyid')
    args = parser.parse_args()

    if not 'pyid' in args.name:
        error("Error",
                  "Please use pyid as extension.")
