...
class Tasks:
    ...
    # Pool water
    OPEN_POOL_WATER = "open-pool-water"
    CLOSE_POOL_WATER = "close-pool-water"
    ...
    # Pool Pump
    TURN_ON_POOL_PUMP = "turn-on-pool-pump"
    TURN_OFF_POOL_PUMP = "turn-off-pool-pump"
    ...
    TASK_MAP = {
        ...
        # Pool water
        OPEN_POOL_WATER: "poolWater?state=open",
        CLOSE_POOL_WATER: "poolWater?state=closed",
        # Smart lock
        ...
        # Pool Pump
        TURN_ON_POOL_PUMP: "poolPump?state=on",
        TURN_OFF_POOL_PUMP: "poolPump?state=off",
        # Bar Pump
    ...
    COUNTER_TASK_MAP = {
        ...
        # Pool water
        OPEN_POOL_WATER: CLOSE_POOL_WATER,
        # Smart lock
        ...
        # Pool Pump
        TURN_ON_POOL_PUMP: TURN_OFF_POOL_PUMP,
        # Bar Pump
