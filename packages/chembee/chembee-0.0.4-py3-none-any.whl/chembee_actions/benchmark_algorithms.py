...
from chembee.utils import prepare_data_decicion_lib
import logging
...
def benchmark_algorithm(
    ...
    for i in range(len(algorithm.titles)):
        ...
        logging.info("Fitted model: ", algorithm.titles[i])
...
if __name__ == "__main__":
    ...
    results = benchmark_standard(X, y, feature_names=iris.feature_names[:2])
    save_json(results, file_name="iris_benchmark.json")
    print(results)
