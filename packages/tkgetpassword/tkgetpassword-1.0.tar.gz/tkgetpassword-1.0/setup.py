...
setup( name = 'tkgetpassword',
    ...
    description = 'Logins to enter password, create password, change password and login, simple way to enter password in tkinter, Tkinter.',
       ...
       url = 'https://github.com/LeonardoReichert/tkgetpassword/releases/tag/v1.0', # use the URL to the github repo download_url = 'https://github.com/{user_name}/{repo}/tarball/0.1',
