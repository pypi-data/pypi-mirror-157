...
def ClusterInstance(stem, props, cluster_id, instance_class=None, engine=None, engine_version=None, apply_immediately=None, snetgrp_name=None, paramgrp_name=None, secgrp_ids=None, provider=None, parent=None, depends_on=None):
