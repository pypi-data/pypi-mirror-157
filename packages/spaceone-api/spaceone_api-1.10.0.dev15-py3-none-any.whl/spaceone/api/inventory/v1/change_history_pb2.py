...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n.spaceone/api/inventory/v1/change_history.proto\x12\x19spaceone.api.inventory.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto\x1a spaceone/api/core/v1/query.proto\"\xae\x02\n\x12\x43hangeHistoryQuery\x12*\n\x05query\x18\x01 \x01(\x0b\x32\x1b.spaceone.api.core.v1.Query\x12\x18\n\x10\x63loud_service_id\x18\x02 \x01(\t\x12J\n\x06\x61\x63tion\x18\x03 \x01(\x0e\x32:.spaceone.api.inventory.v1.ChangeHistoryQuery.RecordAction\x12\x0f\n\x07user_id\x18\x04 \x01(\t\x12\x14\n\x0c\x63ollector_id\x18\x05 \x01(\t\x12\x0e\n\x06job_id\x18\x06 \x01(\t\x12\x11\n\tdomain_id\x18\x07 \x01(\t\"<\n\x0cRecordAction\x12\x08\n\x04NONE\x10\x00\x12\n\n\x06\x43REATE\x10\x01\x12\n\n\x06UPDATE\x10\x02\x12\n\n\x06\x44\x45LETE\x10\x03\"h\n\nRecordDiff\x12\x0b\n\x03key\x18\x01 \x01(\t\x12&\n\x06\x62\x65\x66ore\x18\x02 \x01(\x0b\x32\x16.google.protobuf.Value\x12%\n\x05\x61\x66ter\x18\x03 \x01(\x0b\x32\x16.google.protobuf.Value\"\xe2\x02\n\nRecordInfo\x12\x11\n\trecord_id\x18\x01 \x01(\t\x12\x18\n\x10\x63loud_service_id\x18\x02 \x01(\t\x12\x42\n\x06\x61\x63tion\x18\x03 \x01(\x0e\x32\x32.spaceone.api.inventory.v1.RecordInfo.RecordAction\x12\x33\n\x04\x64iff\x18\x04 \x03(\x0b\x32%.spaceone.api.inventory.v1.RecordDiff\x12\x12\n\ndiff_count\x18\x05 \x01(\x05\x12\x0f\n\x07user_id\x18\x06 \x01(\t\x12\x14\n\x0c\x63ollector_id\x18\x07 \x01(\t\x12\x0e\n\x06job_id\x18\x08 \x01(\t\x12\x11\n\tdomain_id\x18\t \x01(\t\x12\x12\n\ncreated_at\x18\x0b \x01(\t\"<\n\x0cRecordAction\x12\x08\n\x04NONE\x10\x00\x12\n\n\x06\x43REATE\x10\x01\x12\n\n\x06UPDATE\x10\x02\x12\n\n\x06\x44\x45LETE\x10\x03\"`\n\x11\x43hangeHistoryInfo\x12\x36\n\x07results\x18\x01 \x03(\x0b\x32%.spaceone.api.inventory.v1.RecordInfo\x12\x13\n\x0btotal_count\x18\x02 \x01(\x05\"a\n\x16\x43hangeHistoryStatQuery\x12\x34\n\x05query\x18\x01 \x01(\x0b\x32%.spaceone.api.core.v1.StatisticsQuery\x12\x11\n\tdomain_id\x18\x02 \x01(\t2\xc1\x02\n\rChangeHistory\x12\xb0\x01\n\x04list\x12-.spaceone.api.inventory.v1.ChangeHistoryQuery\x1a,.spaceone.api.inventory.v1.ChangeHistoryInfo\"K\x82\xd3\xe4\x93\x02\x45\x12\x1c/inventory/v1/change-historyZ%\"#/inventory/v1/change-history/search\x12}\n\x04stat\x12\x31.spaceone.api.inventory.v1.ChangeHistoryStatQuery\x1a\x17.google.protobuf.Struct\")\x82\xd3\xe4\x93\x02#\"!/inventory/v1/change-history/statb\x06proto3')



_CHANGEHISTORYQUERY = DESCRIPTOR.message_types_by_name['ChangeHistoryQuery']
_RECORDDIFF = DESCRIPTOR.message_types_by_name['RecordDiff']
...
RecordDiff = _reflection.GeneratedProtocolMessageType('RecordDiff', (_message.Message,), {
  'DESCRIPTOR' : _RECORDDIFF,
  '__module__' : 'spaceone.api.inventory.v1.change_history_pb2'
  # @@protoc_insertion_point(class_scope:spaceone.api.inventory.v1.RecordDiff)
  })
_sym_db.RegisterMessage(RecordDiff)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CHANGEHISTORY.methods_by_name['list']._serialized_options = b'\202\323\344\223\002E\022\034/inventory/v1/change-historyZ%\"#/inventory/v1/change-history/search'
  _CHANGEHISTORY.methods_by_name['stat']._options = None
  _CHANGEHISTORY.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002#\"!/inventory/v1/change-history/stat'
  _CHANGEHISTORYQUERY._serialized_start=172
  _CHANGEHISTORYQUERY._serialized_end=474
  _CHANGEHISTORYQUERY_RECORDACTION._serialized_start=414
  _CHANGEHISTORYQUERY_RECORDACTION._serialized_end=474
  _RECORDDIFF._serialized_start=476
  _RECORDDIFF._serialized_end=580
  _RECORDINFO._serialized_start=583
  _RECORDINFO._serialized_end=937
  _RECORDINFO_RECORDACTION._serialized_start=414
  _RECORDINFO_RECORDACTION._serialized_end=474
  _CHANGEHISTORYINFO._serialized_start=939
  _CHANGEHISTORYINFO._serialized_end=1035
  _CHANGEHISTORYSTATQUERY._serialized_start=1037
  _CHANGEHISTORYSTATQUERY._serialized_end=1134
  _CHANGEHISTORY._serialized_start=1137
  _CHANGEHISTORY._serialized_end=1458
