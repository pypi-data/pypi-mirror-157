...
class MainGui(ttk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        app.bind('<Left>',lambda x: servo.pan_tilt_left())
        ...
        app.bind('<Up>',lambda x: servo.pan_tilt_up())
        ...
        app.bind('<Down>',lambda x: servo.pan_tilt_down())
        ...
        app.bind('<Right>',lambda x: servo.pan_tilt_right())
        ...
        add_btn.grid(row=5, column=0, rowspan=2, sticky=W)
        app.bind('<a>',lambda x: acc.t_left() )
        ...
        add_btn.grid(row=6, column=1, rowspan=1, sticky=S)
        app.bind('<s>',lambda x: acc.t_down() )
        ...
        add_btn.grid(row=5, column=2, rowspan=2, sticky=E)
        app.bind('<d>',lambda x: acc.t_right())
        ...
        app.bind('<space>',lambda x: self.stop())
        ...
        self.scale.grid(row=3, column=1, columnspan=1, sticky=EW, padx=5, pady=2)
