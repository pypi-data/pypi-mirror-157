...
class LIB:
    ...
    @staticmethod
    def base64_encrypt(word: str = ''):
        encoded = (b64.b64encode(word.encode("ascii")))
        encoded_ascii = encoded.decode("ascii")
        return encoded_ascii

    @staticmethod
    def base64_decrypt(word: str):
        decoded_ascii = None
        try:
            decoded = b64.b64decode(word.encode('ascii'))
    ...
    @staticmethod
    def token_get(word: str = None) -> str:
