...
class session_IG:
	...
	def follower_session(user: str, session: str,csrf_token: str) -> str:
		...
		'content-length': '0',
		'content-type': 'application/x-www-form-urlencoded',
		'cookie': 'mid=YfHAnwALAAFCLfUn6sJVurIEyEfr; ig_did=DF84157E-69D8-46D5-B090-33F4741C808C; ig_nrcb=1; csrftoken='+str(csrf_token)+'; ds_user_id='+str(session.split(':')[0])+'; sessionid='+str(session)+'; rur="CLN\05453352662133\0541684424578:01f726c10813bcb9113b0f4dcf1be24a5278c0fed11c90001622f46b9b5fdf7010e66eda"',
		'origin': 'https://www.instagram.com',
	...
	def like_post(url: str, session: str, csrf_token: str) -> str:
		...
		'content-length': '0',
		'content-type': 'application/x-www-form-urlencoded',
		'cookie': 'mid=YfHAnwALAAFCLfUn6sJVurIEyEfr; ig_did=DF84157E-69D8-46D5-B090-33F4741C808C; ig_nrcb=1; shbid="19368\05452914264168\0541682536774:01f7c91f0322a7914c4967e12bcfa34c11317752f470517e402d83ba56c43dd701276cd8"; shbts="1651000774\05452914264168\0541682536774:01f704008a362d517796cf36108b67ea9ace8dbfcadcd2a319c9f940d90aa3647ebd9dbe"; csrftoken='+str(csrf_token)+'; ds_user_id='+str(session.split(':')[0])+'; sessionid='+str(session)+'; rur="CLN\05452914264168\0541682560907:01f70b26a7341573483af51f1be279a94d451a4ebb66ffdf3419bec3f98f6850794bf7f7"',
		'origin': 'https://www.instagram.com',
