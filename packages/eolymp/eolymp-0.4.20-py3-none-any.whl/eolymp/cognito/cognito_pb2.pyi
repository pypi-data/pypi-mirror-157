...
class UpdateProfileInput(_message.Message):
    __slots__ = ["birthday", "city", "company", "country", "email", "name", "occupation", "patch", "picture", "username"]
    ...
    PICTURE: UpdateProfileInput.Patch
    ...
    picture: str
    username: str
    def __init__(self, patch: _Optional[_Iterable[_Union[UpdateProfileInput.Patch, str]]] = ..., username: _Optional[str] = ..., email: _Optional[str] = ..., name: _Optional[str] = ..., picture: _Optional[str] = ..., company: _Optional[str] = ..., occupation: _Optional[str] = ..., country: _Optional[str] = ..., city: _Optional[str] = ..., birthday: _Optional[str] = ...) -> None: ...
