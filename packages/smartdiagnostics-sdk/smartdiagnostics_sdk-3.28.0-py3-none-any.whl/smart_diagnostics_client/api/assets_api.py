...
class AssetsApi(object):
    ...
    def get_asset_types(self, **kwargs):  # noqa: E501
        """This route is obsolete. Please use GET /api/v3.0/Assets/Classification/Types instead.  Gets Asset Types  # noqa: E501
        ...
        :param async_req bool
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `CategoryCode` | String | `eq, neq, in, like, isnull, isnotnull` | | `CategoryId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `CategoryName` | String | `eq, neq, in, like, isnull, isnotnull` | | `Code` | String | `eq, neq, in, like, isnull, isnotnull` | | `Name` | String | `eq, neq, in, like, isnull, isnotnull` |
        :param int page: Results page. 1-based (1 returns the first page, 0 is invalid).
        :param int page_limit: Number of items to return per page.
