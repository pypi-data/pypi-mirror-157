...
class NodeSettingOverview(object):
    ...
    def __init__(self, update_interval=None, decimation_factor=None, sampling_frequency=None, operating_mode_pressure=None, operating_mode_vibration=None, number_of_samples=None, compression_type=None):  # noqa: E501
