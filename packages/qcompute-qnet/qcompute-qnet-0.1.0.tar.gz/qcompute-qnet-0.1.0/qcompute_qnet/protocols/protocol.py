...
class Protocol(ABC):
    ...
    def receive_message(self, msg: "Message") -> None:
        r"""Receive a message from the node.
...
class ProtocolStack:
    ...
    Note that the stack relation is maintained by a directed graph.
    ...
    def set(self, protocol_type: str, **kwargs) -> None:
        ...
        """
        assert isinstance(protocol_type, str), "'protocol_type' should be a str."
