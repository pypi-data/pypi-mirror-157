...
class MBQC:
    ...
    def kron_unmeasured_qubits(self) -> None:
        ...
        Warning:
            This is called when user runs MBQC from a measurement pattern.
        """
    ...
    def run_pattern(self) -> None:
        ...
        Warning:
            This is called after ``set_pattern``.
        """
    ...
    def __set_position(self, pos) -> None:
...
def run_circuit(circuit: "Circuit", shots=1024, input_state=None, optimize=True) -> dict:
    ...
    pattern = transpile_to_pattern(new_circuit, shift_signal=True, optimize=optimize, track=False)
