...
class BackendStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FuseFromSearch = channel.unary_unary(
            "/Backend/FuseFromSearch",
            request_serializer=backend__pb2.FuseFromSearchRequest.SerializeToString,
            response_deserializer=backend__pb2.FuseReply.FromString,
        )
...
class BackendServicer(object):
    ...
    def FuseFromSearch(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
...
def add_BackendServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "FuseFromSearch": grpc.unary_unary_rpc_method_handler(
            servicer.FuseFromSearch,
            request_deserializer=backend__pb2.FuseFromSearchRequest.FromString,
            response_serializer=backend__pb2.FuseReply.SerializeToString,
        ),
    }
...
class Backend(object):
    ...
    def FuseFromSearch(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/Backend/FuseFromSearch",
            backend__pb2.FuseFromSearchRequest.SerializeToString,
            backend__pb2.FuseReply.FromString,
            options,
            channel_credentials,
            insecure,
