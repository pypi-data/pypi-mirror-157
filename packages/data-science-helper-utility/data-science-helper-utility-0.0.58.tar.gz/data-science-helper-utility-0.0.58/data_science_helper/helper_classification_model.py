...
def modelar_clasificacion_binaria(strategy="", X_train=None,y_train=None,X_test=None,y_test=None,params=None,enable_cls_opt = False, enable_umbral_opt=False,metric='average_precision',num_rounds=10000,early_stop=400,log=0,api="train_api",random_state=42,url=None,print_consola=True):
    start = time.time()
    ...
    if (enable_cls_opt):
        ...
        args["X_test"]=X_train[list_cls_ini]
        args["url"]=url
