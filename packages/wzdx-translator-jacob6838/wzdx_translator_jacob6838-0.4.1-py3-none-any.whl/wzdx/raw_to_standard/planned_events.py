...
def get_improved_geometry(coordinates, event_status):
    ...
    if startRouteParams['Route'] != endRouteParams['Route']:
        logging.debug("Routes did not match, not generating improved geometry")
        return coordinates
...
def create_rtdh_standard_msg(pd, isIncident):
    ...
    return {
        ...
        "event": {
            ...
            "geometry": get_improved_geometry(coordinates, event_status),
            "header": {
