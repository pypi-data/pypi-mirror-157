...
class DictionaryParameters:
    ...
    @staticmethod
    def GenerateFixedPercent(name, t1Range=(100,5000), t2Range=(1,500), percentStepSize=5, includeB1=False, b1Range=(0.5,1.5), b1Stepsize=0.05):
        new_dictionary_parameters = DictionaryParameters(name)
        T1s = []
        T2s = []
        t1 = t1Range[0]
    ...
    @staticmethod
    def GenerateFixedStep(name, t1Range=(100,5000), t2Range=(1,500), fixedStepSize=1, includeB1=False, b1Range=(0.5,1.5), b1Stepsize=0.05):
        new_dictionary_parameters = DictionaryParameters(name)
        T1s = []
        T2s = []
        t1 = t1Range[0]
