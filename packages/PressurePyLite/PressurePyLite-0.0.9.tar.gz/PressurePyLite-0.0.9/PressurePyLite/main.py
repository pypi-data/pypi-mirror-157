...
def main():
    ...
    while True:
        ...
        # save to file
        if int(target_pressure) - 4 > p:
            save(filename, now, p, "low")                           # save to csv
        if int(target_pressure) + 4 < p:
            save(filename, now, p, "high")
