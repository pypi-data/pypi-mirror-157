    ...
    def json(self):
        return {
            ...
            "data": {
                ...
                "ledger": {
                    "uco": {
                        "transfers": [{"to": to.hex(), "amount": amount} for (to, amount) in self.data["ledger"]["uco"]["transfers"]]
                    },
                    "token": {
                        "transfers": [{"to": to.hex(), "token": token.hex(),  "amount": amount, "token_id": token_id} for (token, to, amount, token_id) in self.data["ledger"]["token"]["transfers"]]
                    }
                },
