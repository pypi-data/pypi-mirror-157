...
class Aqueduct(Base):
    ...
    def __init__(
        ...
        remove_fields_on_destination: bool = False
    ):
        ...
        Args:
            ...
            remove_fields_on_destination: (bool): Whether or not to remove fields on the destination that are not
                                                  on the source instance. Default is False.
        """
        ...
        Base.remove_fields_on_destination = remove_fields_on_destination
    ...
    def sync(self, components=COMPONENTS, exclude: dict = {}, include: dict = {}, dump=False):
        ...
        * roles
        ...
        Args:
            ...
            dump (bool): Whether or not to dump API requests JSON components to a file. Defaults to False.
        """
