...
A user provides ``abrije`` with a list of globs and regexes. The globs are used
to build a list of input files. The regexes tell ``abrije`` how to process each
file.
