...
class PackageDeps():
    def __init__(self, package_name, package_type, lj_dependency_version_expression, dependency_type, version,
    ...
    def package_info(self, package: PackageInfo):
        ...
        if pack_id:
            ...
            return self.conn_local.insert({'package_name': package.package_name, 'description': package.description,
                                            ...
                                            'license': package.license, 'package_type': package.package_type,
