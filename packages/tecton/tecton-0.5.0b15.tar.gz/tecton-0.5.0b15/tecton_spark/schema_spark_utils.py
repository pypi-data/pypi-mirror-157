...
SPARK_TYPE_TO_COLUMN = {
    spark_types.StringType(): _column_proto(
    ...
    spark_types.BooleanType(): _column_proto(
    ...
    spark_types.IntegerType(): _column_proto(
        raw_spark_type="integer",
        feature_server_type=column_type_pb2.COLUMN_TYPE_INT64,
        offline_data_type=Int32Type(),
        feature_server_data_type=Int64Type(),
    ),
    spark_types.FloatType(): _column_proto(
    ...
    spark_types.TimestampType(): _column_proto(
    ...
    # Array types.
    spark_types.ArrayType(spark_types.LongType()): _column_proto(
    ...
    spark_types.ArrayType(spark_types.FloatType()): _column_proto(
    ...
    spark_types.ArrayType(spark_types.DoubleType()): _column_proto(
    ...
    spark_types.ArrayType(spark_types.StringType()): _column_proto(
...
def schema_from_spark(spark_schema: spark_types.StructType) -> Schema:
    ...
    for field in spark_schema:
        ...
        if field.dataType not in SPARK_TYPE_TO_COLUMN:
            raise ValueError(f"Unsupported Spark type: '{field.dataType.simpleString()}' of column '{field.name}'")
        column.CopyFrom(SPARK_TYPE_TO_COLUMN[field.dataType])
