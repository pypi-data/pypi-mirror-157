...
def to_om_osc (L):
    """It will send the values formatted to Lisp using osc."""
    import argparse
    from pythonosc import udp_client
    lisp_formated_data = lispify(L)
    client = udp_client.SimpleUDPClient("127.0.0.1", 300)
    client.send_message("/python", lisp_formated_data)
