...
def compute_extensive_kpis(data_df = None, strat = None):
    ...
    ytd_kpis = riskmetrics.get_kpi(ytd_ohlc_df[[strat]])

    return_ytd_to_date = (current_values['close'] - ytd_values['close'])/ytd_values['close']
    results = {}
    ...
    for nb_month in [1,3,6]:
        ...
        return_to_date = (current_values['close'] - past_values['close'])/past_values['close']
