...
class Ariadne(MessageMixin, RelationshipMixin, OperationMixin, AnnouncementMixin, FileMixin, MultimediaMixin):
    ...
    async def launch(self):
        ...
        logger.critical("Ariadne 0.6.17 is the LAST maintenance version of Ariadne 0.6.x.")
        logger.critical("Please CONSIDER switching to Ariadne 0.7.x if appropriate.")
