...
def lammps_to_ovito(lmp, data_collection = None):
    ...
    This funtion should be called from within a running LAMMPS molecular dynamics simulation to 
    ...
    **Usage example:**
    ...
    on the current simulation shapshot to identify all dislocation defects in the crystal:: 
