...
async def present(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        destination_options(Dict, optional): The destination options. Defaults to None.
            * (FileFormat, optional): The format for the flow log. The default is plain-text.
            * (HiveCompatiblePartitions, optional): Indicates whether to use Hive-compatible prefixes for flow logs stored in Amazon S3. The default
                is false.
            * (PerHourPartition, optional): Indicates whether to partition the flow log per hour. This reduces the cost and response time
