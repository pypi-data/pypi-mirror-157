...
async def present(
    ...
    key_schema: List[
        make_dataclass(
            ...
            [
                ("AttributeName", str, field(default=None)),
                ("KeyType", str, field(default=None)),
            ],
        )
    ],
    ...
    stream_specification: make_dataclass(
        "StreamSpecification",
        [
            ("StreamEnabled", bool, field(default=None)),
            ("StreamViewType", str, field(default=None)),
        ],
    ) = None,
    provisioned_throughput: make_dataclass(
        "ProvisionedThroughput",
        [
            ("ReadCapacityUnits", int, field(default=None)),
            ("WriteCapacityUnits", int, field(default=None)),
        ],
    ) = None,
    local_secondary_indexes: List[
        make_dataclass(
            "LocalSecondaryIndex",
            [
                ("IndexName", str, field(default=None)),
                ("KeySchema", List, field(default=None)),
                ("Projection", Dict, field(default=None)),
            ],
        )
    ] = None,
    global_secondary_indexes: List[
        make_dataclass(
            ...
            [
                ...
                ("KeySchema", List, field(default=None)),
                ("Projection", Dict, field(default=None)),
                ("ProvisionedThroughput", Dict, field(default=None)),
            ],
        )
    ] = None,
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        attribute_definitions(List): An array of attributes that describe the key schema for the table and indexes.
            ...
            * (AttributeType): The data type for the attribute, where:    S - the attribute is of type String    N - the
            attribute is of type Number    B - the attribute is of type Binary
        ...
        global_secondary_indexes(List, optional): One or more global secondary indexes (the maximum is 20) to be created on the table.
            Each global secondary index in the array includes the following:
                ...
                Projection - Specifies attributes that are copied (projected) from the table into the index.
                    ...
                    attributes, which are automatically projected. Each attribute specification is composed of:
                        ...
                        NonKeyAttributes - A list of one or more non-key attribute names that are projected into the secondary index. The total count of attributes
            ...
            * (IndexName): The name of the global secondary index. The name must be unique among all other indexes on this
                table.
            * (KeySchema): The complete key schema for a global secondary index, which consists of one or more pairs of
                ...
                based on their partition key values. The sort key of an item is also known as its range
            ...
            * (Projection): Represents attributes that are copied (projected) from the table into the global secondary
                index. These are in addition to the primary key attributes and index key attributes, which are
                automatically projected.
            * (ProvisionedThroughput, optional): Represents the provisioned throughput settings for the specified global secondary index. For
        ...
        local_secondary_indexes(List, optional): One or more local secondary indexes (the maximum is 5) to be created on the table. Each index is
            ...
            * (IndexName): The name of the local secondary index. The name must be unique among all other indexes on this
                table.
            * (KeySchema): The complete key schema for the local secondary index, consisting of one or more pairs of
                attribute names and key types:
                    HASH - partition key
                    RANGE - sort key
                The partition key of an item is also known as its hash attribute. The term "hash attribute" derives from
        ...
        stream_specification(Dict, optional): The settings for DynamoDB Streams on the table. These settings consist of:
            ...
            * (StreamViewType, optional):  When an item in the table is modified, StreamViewType determines what information is written to
        ...
        sse_specification(Dict, optional): Represents the settings used to enable server-side encryption. Defaults to None.
            * (Enabled, optional): Indicates whether server-side encryption is done using an Amazon Web Services managed key or an
            ...
            * (SSEType, optional): Server-side encryption type.
            ...
            * (KMSMasterKeyId, optional): The KMS key that should be used for the KMS encryption. To specify a key, use its key ID, Amazon
        ...
        tags(List or Dict, optional): The tags to assign to the route_table. Defaults to None. Format can be [{"Key": tag-key, "Value": tag-value}] or dict {tag-key: tag-value}
            * (Key): The key of the tag. Tag keys are case sensitive. Each DynamoDB table can only have up to one tag
