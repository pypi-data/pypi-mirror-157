...
async def present(
    ...
    options: make_dataclass(
        ...
        [
            ...
            ("TransitGatewayCidrBlocks", List, field(default=None)),
        ],
    ) = None,
    tags: Dict[str, Any]
    or List[
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        options(Dict, optional): The transit gateway options. Defaults to None.
            * (AmazonSideAsn, optional): A private Autonomous System Number (ASN) for the Amazon side of a BGP session. The range is
            64512 to 65534 for 16-bit ASNs and 4200000000 to 4294967294 for 32-bit ASNs. The default is
            64512.
            * (AutoAcceptSharedAttachments, optional): Enable or disable automatic acceptance of attachment requests. Disabled by default.
            * (DefaultRouteTableAssociation, optional): Enable or disable automatic association with the default association route table. Enabled by
                default.
            * (DefaultRouteTablePropagation, optional): Enable or disable automatic propagation of routes to the default propagation route table.
                Enabled by default.
            * (VpnEcmpSupport, optional): Enable or disable Equal Cost Multipath Protocol support. Enabled by default.
            * (DnsSupport, optional): Enable or disable DNS support. Enabled by default.
            * (MulticastSupport, optional): Indicates whether multicast is enabled on the transit gateway
            * (TransitGatewayCidrBlocks, optional): One or more IPv4 or IPv6 CIDR blocks for the transit gateway. Must be a size /24 CIDR block or
