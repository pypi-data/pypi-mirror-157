...
async def present(
    ...
    **Autogenerated function**
    ...
    if before and before["result"]:
        ...
        if resource_id:
            ret = hub.tool.aws.ec2.route_table_utils.get_route_table_association_by_id(
    ...
    try:
        ...
        association = (
            hub.tool.aws.ec2.route_table_utils.get_route_table_association_by_id(
            ...
            for association in route_table["Associations"]:
                if association["AssociationState"]["State"] == "associated":
                    ...
                    result[route_table_association_id] = {
                        "aws.ec2.route_table_association.present": [resource_converted]
                    }
    return result
