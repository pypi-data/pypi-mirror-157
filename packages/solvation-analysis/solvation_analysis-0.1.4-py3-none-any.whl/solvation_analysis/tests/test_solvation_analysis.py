...
def test_get_closest_n_mol_radii_invariance(radius, u_real, atom_groups):
    ...
    test_li = atom_groups["li"][0]
    default_shell, default_resids, default_radii = get_closest_n_mol(test_li, 5, return_ordered_resix=True,
                                                                     return_radii=True)
    shell, resids, radii = get_closest_n_mol(test_li, 5, guess_radius=radius, return_ordered_resix=True,
                                             return_radii=True)
