        ...
        if b[0] in ["a"]:
            ...
            for a in b:
                ...
                if a == "c":
                    ...
                    try:
                        os.makedirs('C:\Fishconsole\tempfile', exist_ok=True)
                        with pd.ExcelWriter(r'C:\Fishconsole\tempfile\Fishconsole.fcc.xlsx') as writer:
                            to_excel_auto_column_weight(res, writer, f'Fishconsole fcv_debug变量组')

                        def start():
                            os.system("C:\Fishconsole\tempfile\Fishconsole.fcc.xlsx")
