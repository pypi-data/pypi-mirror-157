...
class Client(Iface):
    ...
    def send_lookupByPhoneNumber(self, countryAreaCode, phoneNumber):
        self._oprot.writeMessageBegin(
            'lookupByPhoneNumber', TMessageType.CALL, self._seqid
        )
    ...
    def recv_lookupNearby(self):
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "lookupNearby failed: unknown result"
        )
...
class Processor(Iface, TProcessor):
    ...
    def process_lookupByPhoneNumber(self, seqid, iprot, oprot):
        ...
        result = lookupByPhoneNumber_result()
        try:
            result.success = self._handler.lookupByPhoneNumber(
                args.countryAreaCode, args.phoneNumber
            )
...
class lookupByPhoneNumber_args(object):
    ...
    def write(self, oprot):
        ...
        if self.countryAreaCode is not None:
            ...
            oprot.writeString(
                self.countryAreaCode.encode('utf-8')
                if sys.version_info[0] == 2
                else self.countryAreaCode
            )
            oprot.writeFieldEnd()
