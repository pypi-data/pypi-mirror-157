...
# TODO Функция перенесена из Django 2.2 в угоду совместимости с Django 1.11 используемой на текущий момент в ОБР. Стоит
#  выпилить после повышения версии Django в ОБР
