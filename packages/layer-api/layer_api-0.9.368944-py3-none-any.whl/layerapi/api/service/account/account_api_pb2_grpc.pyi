...
class AccountAPIStub:
    ...
    CreateAccountV2: grpc.UnaryUnaryMultiCallable[
        api.service.account.account_api_pb2.CreateAccountV2Request,
        api.service.account.account_api_pb2.CreateAccountV2Response]
...
class AccountAPIServicer(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def CreateAccountV2(self,
        request: api.service.account.account_api_pb2.CreateAccountV2Request,
        context: grpc.ServicerContext,
    ) -> api.service.account.account_api_pb2.CreateAccountV2Response: ...
