...
from kolibri.task.entities.templated_extractor import TemplatedEntityExtractor
from kolibri.task.entities.person_extractor import PersonExtractor
from kolibri.task.entities.regex_extractor import RegexExtractor
from kolibri.task.entities.dictionaryExtractor import DictionaryExtractor
from kolibri.task.entities.common_reg_extractor import CommonRegexExtractor
