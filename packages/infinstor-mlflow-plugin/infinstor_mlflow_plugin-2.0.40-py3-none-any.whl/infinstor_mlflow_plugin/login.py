...
def bootstrap_from_mlflow_rest() -> Dict[str,str]:
    ...
    if (pmuri.scheme.lower() != 'infinstor'):
        ...
        logger.error("Error: MLFLOW_TRACKING_URI environment variable must be set to infinstor://<mlflowSubDomain>.<InfinstorServiceName> (for example infinstor://mlflow.infinstor.com).  Check documentation for details. Set this environment variable and retry.")
        exit(1)
