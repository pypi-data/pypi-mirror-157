...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, versions_href=None, name=None, retain_repo_versions=None, manifest_signing_service=None, latest_version_href=None, pulp_labels=None, description=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
