...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, description=None, name=None, manifest_signing_service=None, pulp_href=None, pulp_labels=None, retain_repo_versions=None, latest_version_href=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
