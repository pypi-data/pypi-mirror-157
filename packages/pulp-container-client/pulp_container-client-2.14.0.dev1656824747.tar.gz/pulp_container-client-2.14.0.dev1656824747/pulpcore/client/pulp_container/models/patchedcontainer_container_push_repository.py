...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, description=None, name=None, manifest_signing_service=None, pulp_labels=None, retain_repo_versions=None, local_vars_configuration=None):  # noqa: E501
