...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, pulp_labels=None, description=None, manifest_signing_service=None, retain_repo_versions=None, name=None, local_vars_configuration=None):  # noqa: E501
