...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, retain_repo_versions=None, description=None, manifest_signing_service=None, name=None, versions_href=None, pulp_labels=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
