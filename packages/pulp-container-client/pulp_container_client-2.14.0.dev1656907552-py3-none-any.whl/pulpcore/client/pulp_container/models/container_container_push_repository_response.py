...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, description=None, manifest_signing_service=None, latest_version_href=None, versions_href=None, retain_repo_versions=None, pulp_href=None, name=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
