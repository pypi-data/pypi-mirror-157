...
class NssSource(object):
    ...
    def _correlation_matrice(self):
        ...
        if t is str:
            ...
            print("{}: unmanaged data type for corr_vec column".format(type(self._star["corr_vec"])))
    ...
    def _fields(self):
        ...
        if star_type == "Orbital":
            ...
            print("Uknown start type {}".format(star_type))
    ...
    def covmat(self):
        ...
        if len(self._cormat) != len_err * ((len_err - 1) / 2):
            print("Errors size {} and Cormat size {} are not compatible".format(len_err, len(self._cormat)))
    ...
    def campbell(self):
        ...
        if not star_type.startswith("Orbital") and star_type != "AstroSpectroSB1":
            print("Cannot compute Campbell parameters for star type {}".format(star_type))
