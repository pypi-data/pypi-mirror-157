...
class MonetaryPolicyCommittee(object):
    ...
    def __init__(self,
        ...
        if (start_year >= datetime.today().year) or (historical_split >= datetime.today().year):
            raise ValueError("The 'start_year' argument and 'historical_split' argument must be in the past.")
        if historical_split < start_year:
...
if __name__ == '__main__':
    ...
    MonetaryPolicyCommittee().pickle_data("FILEPATH\\abc.pkl")
