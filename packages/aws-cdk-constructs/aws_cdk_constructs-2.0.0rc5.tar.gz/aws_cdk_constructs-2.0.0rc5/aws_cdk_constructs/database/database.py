...
class Database(Construct):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        cdk.CfnOutput(self, f"DatabaseAppName{output_id}", export_name=f"DatabaseAppName{output_id}", value=str(app_name))
        cdk.CfnOutput(self, f"DatabaseIsHa{output_id}", export_name=f"DatabaseIsHa{output_id}", value=str(is_ha))
        cdk.CfnOutput(self, f"DatabaseEngine{output_id}", export_name=f"DatabaseEngine{output_id}", value=str(database_engine))
        cdk.CfnOutput(self, f"DatabaseEngineVersion{output_id}", export_name=f"DatabaseEngineVersion{output_id}", value=str(database_engine_version))
        # cdk.CfnOutput(self, f"DatabaseAllocatedStorage{output_id}", export_name=f"DatabaseAllocatedStorage{output_id}", value=str(database_allocated_storage))
        cdk.CfnOutput(self, f"DatabaseWillSendEmail{output_id}", export_name=f"DatabaseWillSendEmail{output_id}", value=str(sends_emails))
        cdk.CfnOutput(self, f"DatabaseHasBackup{output_id}", export_name=f"DatabaseHasBackup{output_id}", value=str(to_be_backed_up))
        cdk.CfnOutput(self, f"DatabaseName{output_id}", export_name=f"DatabaseName{output_id}", value=str(database_name))
        cdk.CfnOutput(self, f"DatabaseIdentifierPrefix{output_id}", export_name=f"DatabaseIdentifierPrefix{output_id}", value=str(identifier_prefix))
