...
class Database(Construct):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        cdk.CfnOutput(self, f"DatabaseAppName{app_name}{output_id}", export_name=f"DatabaseAppName{app_name}{output_id}", value=str(app_name))
        cdk.CfnOutput(self, f"DatabaseIsHa{app_name}{output_id}", export_name=f"DatabaseIsHa{app_name}{output_id}", value=str(is_ha))
        cdk.CfnOutput(self, f"DatabaseEngine{app_name}{output_id}", export_name=f"DatabaseEngine{app_name}{output_id}", value=str(database_engine))
        cdk.CfnOutput(self, f"DatabaseEngineVersion{app_name}{output_id}", export_name=f"DatabaseEngineVersion{app_name}{output_id}", value=str(database_engine_version))
        # cdk.CfnOutput(self, f"DatabaseAllocatedStorage{app_name}{output_id}", export_name=f"DatabaseAllocatedStorage{app_name}{output_id}", value=str(database_allocated_storage))
        cdk.CfnOutput(self, f"DatabaseWillSendEmail{app_name}{output_id}", export_name=f"DatabaseWillSendEmail{app_name}{output_id}", value=str(sends_emails))
        cdk.CfnOutput(self, f"DatabaseHasBackup{app_name}{output_id}", export_name=f"DatabaseHasBackup{app_name}{output_id}", value=str(to_be_backed_up))
        cdk.CfnOutput(self, f"DatabaseName{app_name}{output_id}", export_name=f"DatabaseName{app_name}{output_id}", value=str(database_name))
        cdk.CfnOutput(self, f"DatabaseIdentifierPrefix{app_name}{output_id}", export_name=f"DatabaseIdentifierPrefix{app_name}{output_id}", value=str(identifier_prefix))
