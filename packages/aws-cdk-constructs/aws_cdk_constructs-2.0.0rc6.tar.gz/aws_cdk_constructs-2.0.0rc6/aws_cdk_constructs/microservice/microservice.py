...
class Microservice(Construct):
    ...
    def __init__(
        ...
        **kwargs
        ...
        cdk.CfnOutput(self, f"MicroserviceId{app_name}{main_component_name}", export_name= f"MicroserviceId{app_name}{main_component_name}", value=str(self.id))
        cdk.CfnOutput(self, f"MicroserviceAppName{app_name}{main_component_name}", export_name=f"MicroserviceAppName{app_name}{main_component_name}", value=str(app_name))
        cdk.CfnOutput(self, f"MicroserviceMainComponentName{app_name}{main_component_name}", export_name=f"MicroserviceMainComponentName{app_name}{main_component_name}", value=str(main_component_name))
        cdk.CfnOutput(self, f"MicroserviceIsPublic{app_name}{main_component_name}", export_name=f"MicroserviceIsPublic{app_name}{main_component_name}", value=str(is_public))
        cdk.CfnOutput(self, f"MicroserviceUseCdn{app_name}{main_component_name}", export_name=f"MicroserviceUseCdn{app_name}{main_component_name}", value=str(use_cdn))
        cdk.CfnOutput(self, f"MicroserviceHasUpstream{app_name}{main_component_name}", export_name=f"MicroserviceHasUpstream{app_name}{main_component_name}", value=str(has_upstream))
        cdk.CfnOutput(self, f"MicroserviceIsHa{app_name}{main_component_name}", export_name=f"MicroserviceIsHa{app_name}{main_component_name}", value=str(is_ha))
        cdk.CfnOutput(self, f"MicroserviceUseEbs{app_name}{main_component_name}", export_name=f"MicroserviceUseEbs{app_name}{main_component_name}", value=str(use_ebs))
        cdk.CfnOutput(self, f"MicroserviceUseEfs{app_name}{main_component_name}", export_name=f"MicroserviceUseEfs{app_name}{main_component_name}", value=str(create_efs))
        cdk.CfnOutput(self, f"MicroserviceHasOidc{app_name}{main_component_name}", export_name=f"MicroserviceHasOidc{app_name}{main_component_name}", value=str(has_not_oidc))
        cdk.CfnOutput(self, f"MicroserviceAsgLogicalId{app_name}{main_component_name}", export_name=f"MicroserviceAutoscalingGroupLogicalId{app_name}{main_component_name}", value=str(AUTOSCALING_GROUP_LOGICAL_ID))
        cdk.CfnOutput(self, f"MicroserviceUseLdap{app_name}{main_component_name}", export_name=f"MicroserviceUseLdap{app_name}{main_component_name}",value=str(use_ldap))
        cdk.CfnOutput(self, f"MicroserviceHasBackup{app_name}{main_component_name}", export_name=f"MicroserviceHasBackup{app_name}{main_component_name}", value=str(to_be_backed_up))
        cdk.CfnOutput(self, f"MicroserviceIsHttps{app_name}{main_component_name}", export_name=f"MicroserviceIsHttps{app_name}{main_component_name}",value=str(is_https))
