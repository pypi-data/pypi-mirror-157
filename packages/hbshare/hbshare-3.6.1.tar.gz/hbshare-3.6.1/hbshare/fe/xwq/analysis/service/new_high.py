...
if __name__ == '__main__':
    ...
    for date in date_list:
        ...
        if date <= '20220331':
            fmt = pd.read_hdf('D:/Git/hbshare/hbshare/fe/xwq/data/fmt_2021A.hdf', key='table')
        else:
            fmt = pd.read_hdf('D:/Git/hbshare/hbshare/fe/xwq/data/fmt_2022Q1.hdf', key='table')
    ...
    df.to_excel('D:/Git/hbshare/hbshare/fe/xwq/data/创新高.xlsx')