...
class IndustryAnalysis:
    ...
    def get_all(self):
        # excel_writer = pd.ExcelWriter('D:/Git/hbshare/hbshare/fe/xwq/data/industry_analysis/行业数据跟踪_{0}.xlsx'.format(self.end_date), engine='xlsxwriter')
        # worksheet1 = excel_writer.book.add_worksheet('技术面')
        # worksheet2 = excel_writer.book.add_worksheet('估值面')
        # worksheet3 = excel_writer.book.add_worksheet('基本面')
        # excel_writer.save()
