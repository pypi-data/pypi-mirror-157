...
def init_locations_dictionary():
    black_list_codes = {code: True for code in parse_txt_file('workers/geo_detector/data/blacklisted_codes.txt')}
    black_list_names = [name for name in parse_txt_file('workers/geo_detector/data/blacklisted_names.txt')]
    countries_info = [name for name in parse_txt_file('workers/geo_detector/data/countryInfo.txt')]
